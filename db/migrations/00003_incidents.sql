...
ALTER TABLE ONLY public.incident_memberships
    ADD CONSTRAINT incident_memberships_added_by_user_id_fkey FOREIGN KEY (added_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.incident_memberships
    ADD CONSTRAINT incident_memberships_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.incident_memberships
    ADD CONSTRAINT incident_memberships_updated_by_user_id_fkey FOREIGN KEY (updated_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.incident_memberships
    ADD CONSTRAINT incident_memberships_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.incident_workbook_preferences
    ADD CONSTRAINT incident_workbook_preferences_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.incident_workbook_preferences
    ADD CONSTRAINT incident_workbook_preferences_updated_by_user_id_fkey FOREIGN KEY (updated_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.incidents
    ADD CONSTRAINT incidents_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.incidents
    ADD CONSTRAINT incidents_updated_by_user_id_fkey FOREIGN KEY (updated_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.user_workbook_preferences
    ADD CONSTRAINT user_workbook_preferences_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.user_workbook_preferences
    ADD CONSTRAINT user_workbook_preferences_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE CASCADE;

CREATE INDEX incident_memberships_added_by_user_id_fk_idx ON public.incident_memberships (added_by_user_id);
CREATE INDEX incident_memberships_updated_by_user_id_fk_idx ON public.incident_memberships (updated_by_user_id);
CREATE INDEX incident_workbook_preferences_updated_by_user_id_fk_idx ON public.incident_workbook_preferences (updated_by_user_id);
CREATE INDEX incidents_created_by_user_id_fk_idx ON public.incidents (created_by_user_id);
CREATE INDEX incidents_updated_by_user_id_fk_idx ON public.incidents (updated_by_user_id);
CREATE INDEX user_workbook_preferences_user_id_fk_idx ON public.user_workbook_preferences (user_id);

-- +goose Down
DROP TABLE public.incident_memberships ;
DROP TABLE public.incident_workbook_preferences ;
DROP TABLE public.user_workbook_preferences ;
