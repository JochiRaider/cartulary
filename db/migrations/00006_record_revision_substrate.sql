...
ALTER TABLE ONLY public.change_set_mutations
    ADD CONSTRAINT change_set_mutations_change_set_id_fkey FOREIGN KEY (change_set_id) REFERENCES public.change_sets(change_set_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.change_sets
    ADD CONSTRAINT change_sets_actor_user_id_fkey FOREIGN KEY (actor_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.change_sets
    ADD CONSTRAINT change_sets_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.record_history_entry_refs
    ADD CONSTRAINT record_history_entry_refs_change_set_id_fkey FOREIGN KEY (change_set_id) REFERENCES public.change_sets(change_set_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.record_history_entry_refs
    ADD CONSTRAINT record_history_entry_refs_change_set_id_mutation_sequence__fkey FOREIGN KEY (change_set_id, mutation_sequence_no) REFERENCES public.change_set_mutations(change_set_id, sequence_no) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.record_history_entry_refs
    ADD CONSTRAINT record_history_entry_refs_record_id_fkey FOREIGN KEY (record_id) REFERENCES public.records(record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.record_revisions
    ADD CONSTRAINT record_revisions_change_set_id_fkey FOREIGN KEY (change_set_id) REFERENCES public.change_sets(change_set_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.record_revisions
    ADD CONSTRAINT record_revisions_record_id_fkey FOREIGN KEY (record_id) REFERENCES public.records(record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.records
    ADD CONSTRAINT records_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.records
    ADD CONSTRAINT records_deleted_by_user_id_fkey FOREIGN KEY (deleted_by_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.records
    ADD CONSTRAINT records_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.records
    ADD CONSTRAINT records_updated_by_user_id_fkey FOREIGN KEY (updated_by_user_id) REFERENCES public.users(id);

-- +goose Down
DROP SEQUENCE IF EXISTS public.record_revisions_revision_id_seq;
DROP TABLE IF EXISTS public.records CASCADE;
DROP TABLE IF EXISTS public.change_sets CASCADE;
DROP TABLE IF EXISTS public.change_set_mutations CASCADE;
DROP TABLE IF EXISTS public.record_revisions CASCADE;
DROP TABLE IF EXISTS public.record_history_entry_refs CASCADE;
