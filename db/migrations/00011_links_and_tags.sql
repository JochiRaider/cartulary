...
ALTER TABLE ONLY public.record_links
    ADD CONSTRAINT record_links_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.record_links
    ADD CONSTRAINT record_links_deleted_by_user_id_fkey FOREIGN KEY (deleted_by_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.record_links
    ADD CONSTRAINT record_links_dst_record_envelope_fkey FOREIGN KEY (incident_id, dst_record_id) REFERENCES public.records(incident_id, record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.record_links
    ADD CONSTRAINT record_links_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.record_links
    ADD CONSTRAINT record_links_owner_user_id_fkey FOREIGN KEY (owner_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.record_links
    ADD CONSTRAINT record_links_src_record_envelope_fkey FOREIGN KEY (incident_id, src_record_id) REFERENCES public.records(incident_id, record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.record_tags
    ADD CONSTRAINT record_tags_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.record_tags
    ADD CONSTRAINT record_tags_deleted_by_user_id_fkey FOREIGN KEY (deleted_by_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.record_tags
    ADD CONSTRAINT record_tags_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.record_tags
    ADD CONSTRAINT record_tags_record_envelope_fkey FOREIGN KEY (incident_id, record_id) REFERENCES public.records(incident_id, record_id) ON DELETE CASCADE;

-- +goose Down
DROP TABLE IF EXISTS public.record_links CASCADE;
