...
CREATE TABLE public.entity_aliases (
    ...
    normalized_text citext NOT NULL,
    ...
    CONSTRAINT entity_aliases_alias_text_nonempty_ck CHECK (normalized_text::text <> ''),
    CONSTRAINT entity_aliases_alias_text_length_ck CHECK (char_length(normalized_text::text) <= 256),
    CONSTRAINT entity_aliases_alias_text_controls_ck CHECK (normalized_text::text !~ '[[:cntrl:]]'),
    CONSTRAINT entity_aliases_alias_text_storage_ck CHECK (raw_text = normalized_text::text)
);
...
ALTER TABLE ONLY public.entity_aliases
    ADD CONSTRAINT entity_aliases_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.entity_aliases
    ADD CONSTRAINT entity_aliases_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.entity_mentions
    ADD CONSTRAINT entity_mentions_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.entity_mentions
    ADD CONSTRAINT entity_mentions_resolved_by_user_id_fkey FOREIGN KEY (resolved_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.entity_mentions
    ADD CONSTRAINT entity_mentions_source_record_envelope_fkey FOREIGN KEY (source_record_id) REFERENCES public.records(record_id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.entity_preserved_identifiers
    ADD CONSTRAINT entity_preserved_identifiers_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.entity_preserved_identifiers
    ADD CONSTRAINT entity_preserved_identifiers_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.hosts
    ADD CONSTRAINT hosts_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.hosts
    ADD CONSTRAINT hosts_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.hosts
    ADD CONSTRAINT hosts_merged_into_record_id_fkey FOREIGN KEY (merged_into_record_id) REFERENCES public.hosts(record_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.hosts
    ADD CONSTRAINT hosts_record_envelope_fkey FOREIGN KEY (incident_id, record_id) REFERENCES public.records(incident_id, record_id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.hosts
    ADD CONSTRAINT hosts_seed_entity_mention_id_fkey FOREIGN KEY (seed_entity_mention_id) REFERENCES public.entity_mentions(entity_mention_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.hosts
    ADD CONSTRAINT hosts_updated_by_user_id_fkey FOREIGN KEY (updated_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.identities
    ADD CONSTRAINT identities_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.identities
    ADD CONSTRAINT identities_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.identities
    ADD CONSTRAINT identities_merged_into_record_id_fkey FOREIGN KEY (merged_into_record_id) REFERENCES public.identities(record_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.identities
    ADD CONSTRAINT identities_record_envelope_fkey FOREIGN KEY (incident_id, record_id) REFERENCES public.records(incident_id, record_id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.identities
    ADD CONSTRAINT identities_seed_entity_mention_id_fkey FOREIGN KEY (seed_entity_mention_id) REFERENCES public.entity_mentions(entity_mention_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.identities
    ADD CONSTRAINT identities_updated_by_user_id_fkey FOREIGN KEY (updated_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;

CREATE INDEX entity_aliases_created_by_user_id_fk_idx ON public.entity_aliases (created_by_user_id);
CREATE INDEX entity_mentions_created_by_user_id_fk_idx ON public.entity_mentions (created_by_user_id);
CREATE INDEX entity_mentions_resolved_by_user_id_fk_idx ON public.entity_mentions (resolved_by_user_id);
CREATE INDEX entity_preserved_identifiers_created_by_user_id_fk_idx ON public.entity_preserved_identifiers (created_by_user_id);
CREATE INDEX hosts_created_by_user_id_fk_idx ON public.hosts (created_by_user_id);
CREATE INDEX hosts_incident_id_record_id_fk_idx ON public.hosts (incident_id, record_id);
CREATE INDEX hosts_merged_into_record_id_fk_idx ON public.hosts (merged_into_record_id);
CREATE INDEX hosts_seed_entity_mention_id_fk_idx ON public.hosts (seed_entity_mention_id);
CREATE INDEX hosts_updated_by_user_id_fk_idx ON public.hosts (updated_by_user_id);
CREATE INDEX identities_created_by_user_id_fk_idx ON public.identities (created_by_user_id);
CREATE INDEX identities_incident_id_record_id_fk_idx ON public.identities (incident_id, record_id);
CREATE INDEX identities_merged_into_record_id_fk_idx ON public.identities (merged_into_record_id);
CREATE INDEX identities_seed_entity_mention_id_fk_idx ON public.identities (seed_entity_mention_id);
CREATE INDEX identities_updated_by_user_id_fk_idx ON public.identities (updated_by_user_id);

CREATE INDEX entity_aliases_incident_id_fk_idx ON public.entity_aliases (incident_id);
CREATE INDEX entity_preserved_identifiers_incident_id_fk_idx
    ON public.entity_preserved_identifiers (incident_id);

-- +goose Down
DROP TABLE public.hosts;
DROP TABLE public.identities;
DROP TABLE public.entity_mentions;
DROP TABLE public.entity_preserved_identifiers;
DROP TABLE public.entity_aliases;
