...
ALTER TABLE ONLY public.artifact_grid_projection
    ADD CONSTRAINT artifact_grid_projection_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.artifact_grid_projection
    ADD CONSTRAINT artifact_grid_projection_finding_owner_user_id_fkey FOREIGN KEY (finding_owner_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.artifact_grid_projection
    ADD CONSTRAINT artifact_grid_projection_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.artifact_grid_projection
    ADD CONSTRAINT artifact_grid_projection_incoming_owner_user_id_fkey FOREIGN KEY (incoming_owner_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.artifact_grid_projection
    ADD CONSTRAINT artifact_grid_projection_investigative_query_created_by_us_fkey FOREIGN KEY (investigative_query_created_by_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.artifact_grid_projection
    ADD CONSTRAINT artifact_grid_projection_outgoing_owner_user_id_fkey FOREIGN KEY (outgoing_owner_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.artifact_grid_projection
    ADD CONSTRAINT artifact_grid_projection_owner_user_id_fkey FOREIGN KEY (owner_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.artifact_grid_projection
    ADD CONSTRAINT artifact_grid_projection_record_id_fkey FOREIGN KEY (record_id) REFERENCES public.artifacts(record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.artifact_grid_projection
    ADD CONSTRAINT artifact_grid_projection_review_owner_user_id_fkey FOREIGN KEY (review_owner_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.assessment_grid_projection
    ADD CONSTRAINT assessment_grid_projection_assessor_fkey FOREIGN KEY (assessor) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.assessment_grid_projection
    ADD CONSTRAINT assessment_grid_projection_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.assessment_grid_projection
    ADD CONSTRAINT assessment_grid_projection_record_id_fkey FOREIGN KEY (record_id) REFERENCES public.assessments(record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.decision_grid_projection
    ADD CONSTRAINT decision_grid_projection_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.decision_grid_projection
    ADD CONSTRAINT decision_grid_projection_owner_user_id_fkey FOREIGN KEY (owner_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.decision_grid_projection
    ADD CONSTRAINT decision_grid_projection_record_id_fkey FOREIGN KEY (record_id) REFERENCES public.decisions(record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.evidence_grid_projection
    ADD CONSTRAINT evidence_grid_projection_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.evidence_grid_projection
    ADD CONSTRAINT evidence_grid_projection_record_id_fkey FOREIGN KEY (record_id) REFERENCES public.evidence(record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.host_grid_projection
    ADD CONSTRAINT host_grid_projection_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.host_grid_projection
    ADD CONSTRAINT host_grid_projection_record_id_fkey FOREIGN KEY (record_id) REFERENCES public.hosts(record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.identity_grid_projection
    ADD CONSTRAINT identity_grid_projection_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.identity_grid_projection
    ADD CONSTRAINT identity_grid_projection_record_id_fkey FOREIGN KEY (record_id) REFERENCES public.identities(record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.indicator_grid_projection
    ADD CONSTRAINT indicator_grid_projection_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.indicator_grid_projection
    ADD CONSTRAINT indicator_grid_projection_record_id_fkey FOREIGN KEY (record_id) REFERENCES public.indicators(record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.party_grid_projection
    ADD CONSTRAINT party_grid_projection_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.party_grid_projection
    ADD CONSTRAINT party_grid_projection_record_id_fkey FOREIGN KEY (record_id) REFERENCES public.parties(record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.task_request_grid_projection
    ADD CONSTRAINT task_request_grid_projection_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.task_request_grid_projection
    ADD CONSTRAINT task_request_grid_projection_owner_user_id_fkey FOREIGN KEY (owner_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.task_request_grid_projection
    ADD CONSTRAINT task_request_grid_projection_record_id_fkey FOREIGN KEY (record_id) REFERENCES public.task_requests(record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.timeline_grid_projection
    ADD CONSTRAINT timeline_grid_projection_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.timeline_grid_projection
    ADD CONSTRAINT timeline_grid_projection_record_id_fkey FOREIGN KEY (record_id) REFERENCES public.timeline_events(record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.timeline_grid_projection
    ADD CONSTRAINT timeline_grid_projection_replacement_record_id_fkey FOREIGN KEY (replacement_record_id) REFERENCES public.timeline_events(record_id);

-- +goose Down
DROP TABLE IF EXISTS public.timeline_grid_projection CASCADE;
DROP TABLE IF EXISTS public.host_grid_projection CASCADE;
DROP TABLE IF EXISTS public.identity_grid_projection CASCADE;
DROP TABLE IF EXISTS public.indicator_grid_projection CASCADE;
DROP TABLE IF EXISTS public.assessment_grid_projection CASCADE;
DROP TABLE IF EXISTS public.task_request_grid_projection CASCADE;
DROP TABLE IF EXISTS public.decision_grid_projection CASCADE;
DROP TABLE IF EXISTS public.artifact_grid_projection CASCADE;
DROP TABLE IF EXISTS public.evidence_grid_projection CASCADE;
DROP TABLE IF EXISTS public.party_grid_projection CASCADE;
