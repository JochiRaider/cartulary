...
CREATE TABLE public.enterprise_auth_providers (
    ...
    jwks_uri text,
    client_id text,
    client_secret_ref_kind text,
    client_secret_ref_name text,
    additional_scopes jsonb NOT NULL DEFAULT '[]'::jsonb,
    saml_idp_entity_id text,
    saml_sso_url text,
    saml_idp_signing_certificates jsonb NOT NULL DEFAULT '[]'::jsonb,
    saml_sp_entity_id text,
    saml_subject_source jsonb,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
...
ALTER TABLE ONLY public.account_preferences
    ADD CONSTRAINT account_preferences_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.bootstrap_tokens
    ADD CONSTRAINT bootstrap_tokens_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.enterprise_auth_bindings
    ADD CONSTRAINT enterprise_auth_bindings_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.enterprise_auth_bindings
    ADD CONSTRAINT enterprise_auth_bindings_provider_id_fkey FOREIGN KEY (provider_id) REFERENCES public.enterprise_auth_providers(id) ON UPDATE NO ACTION ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.enterprise_auth_bindings
    ADD CONSTRAINT enterprise_auth_bindings_replaced_by_auth_binding_id_fkey FOREIGN KEY (replaced_by_auth_binding_id) REFERENCES public.enterprise_auth_bindings(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.enterprise_auth_bindings
    ADD CONSTRAINT enterprise_auth_bindings_retired_by_user_id_fkey FOREIGN KEY (retired_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.enterprise_auth_bindings
    ADD CONSTRAINT enterprise_auth_bindings_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.enterprise_auth_transactions
    ADD CONSTRAINT enterprise_auth_transactions_provider_id_fkey FOREIGN KEY (provider_id) REFERENCES public.enterprise_auth_providers(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.pending_totp_enrollments
    ADD CONSTRAINT pending_totp_enrollments_auth_scope_bootstrap_token_id_fkey FOREIGN KEY (auth_scope_bootstrap_token_id) REFERENCES public.bootstrap_tokens(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.pending_totp_enrollments
    ADD CONSTRAINT pending_totp_enrollments_auth_scope_session_id_fkey FOREIGN KEY (auth_scope_session_id) REFERENCES public.user_sessions(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.pending_totp_enrollments
    ADD CONSTRAINT pending_totp_enrollments_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.route_idempotency
    ADD CONSTRAINT route_idempotency_actor_user_id_fkey FOREIGN KEY (actor_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.route_idempotency
    ADD CONSTRAINT route_idempotency_target_user_id_fkey FOREIGN KEY (target_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.user_sessions
    ADD CONSTRAINT user_sessions_auth_binding_id_fkey FOREIGN KEY (auth_binding_id) REFERENCES public.enterprise_auth_bindings(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.user_sessions
    ADD CONSTRAINT user_sessions_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.users
    ADD CONSTRAINT users_updated_by_user_id_fkey FOREIGN KEY (updated_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;

CREATE INDEX enterprise_auth_bindings_created_by_user_id_fk_idx ON public.enterprise_auth_bindings (created_by_user_id);
CREATE INDEX enterprise_auth_bindings_replaced_by_auth_binding_id_fk_idx ON public.enterprise_auth_bindings (replaced_by_auth_binding_id);
CREATE INDEX enterprise_auth_bindings_retired_by_user_id_fk_idx ON public.enterprise_auth_bindings (retired_by_user_id);
CREATE INDEX pending_totp_enrollments_auth_scope_bootstrap_token_id_fk_idx ON public.pending_totp_enrollments (auth_scope_bootstrap_token_id);
CREATE INDEX pending_totp_enrollments_auth_scope_session_id_fk_idx ON public.pending_totp_enrollments (auth_scope_session_id);
CREATE INDEX route_idempotency_target_user_id_fk_idx ON public.route_idempotency (target_user_id);
CREATE INDEX user_sessions_auth_binding_id_fk_idx ON public.user_sessions (auth_binding_id);
CREATE INDEX users_updated_by_user_id_fk_idx ON public.users (updated_by_user_id);

CREATE INDEX enterprise_auth_bindings_provider_id_fk_idx
    ON public.enterprise_auth_bindings (provider_id);
CREATE INDEX enterprise_auth_bindings_user_id_fk_idx
    ON public.enterprise_auth_bindings (user_id);
CREATE INDEX pending_totp_enrollments_user_id_fk_idx
    ON public.pending_totp_enrollments (user_id);

-- +goose Down
DROP TABLE public.pending_totp_enrollments ;
DROP TABLE public.route_idempotency ;
DROP TABLE public.account_preferences ;
DROP TABLE public.enterprise_auth_transactions ;
DROP TABLE public.user_sessions ;
DROP TABLE public.enterprise_auth_bindings ;
DROP TABLE public.bootstrap_tokens ;
DROP TABLE public.enterprise_auth_providers ;
