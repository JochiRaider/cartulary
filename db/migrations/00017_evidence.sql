...
CREATE UNIQUE INDEX evidence_object_blob_unique_idx ON public.evidence USING btree (object_blob_id) WHERE (object_blob_id IS NOT NULL);
...
ALTER TABLE ONLY public.evidence_access_handles
    ADD CONSTRAINT evidence_access_handles_evidence_fkey FOREIGN KEY (incident_id, record_id) REFERENCES public.evidence(incident_id, record_id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.evidence_access_handles
    ADD CONSTRAINT evidence_access_handles_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.evidence_access_handles
    ADD CONSTRAINT evidence_access_handles_issued_by_user_id_fkey FOREIGN KEY (issued_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.evidence_access_handles
    ADD CONSTRAINT evidence_access_handles_object_blob_id_fkey FOREIGN KEY (object_blob_id) REFERENCES public.object_blobs(object_blob_id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.evidence_custody_events
    ADD CONSTRAINT evidence_custody_events_actor_user_id_fkey FOREIGN KEY (actor_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.evidence_custody_events
    ADD CONSTRAINT evidence_custody_events_evidence_record_id_fkey FOREIGN KEY (evidence_record_id) REFERENCES public.evidence(record_id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.evidence_custody_events
    ADD CONSTRAINT evidence_custody_events_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.evidence
    ADD CONSTRAINT evidence_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.evidence
    ADD CONSTRAINT evidence_object_blob_fkey FOREIGN KEY (object_blob_id) REFERENCES public.object_blobs(object_blob_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.evidence
    ADD CONSTRAINT evidence_record_envelope_fkey FOREIGN KEY (incident_id, record_id) REFERENCES public.records(incident_id, record_id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.object_blobs
    ADD CONSTRAINT object_blobs_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.object_blobs
    ADD CONSTRAINT object_blobs_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON UPDATE NO ACTION ON DELETE CASCADE;

CREATE INDEX evidence_access_handles_issued_by_user_id_fk_idx ON public.evidence_access_handles (issued_by_user_id);
CREATE INDEX evidence_access_handles_object_blob_id_fk_idx ON public.evidence_access_handles (object_blob_id);
CREATE INDEX evidence_custody_events_actor_user_id_fk_idx ON public.evidence_custody_events (actor_user_id);
CREATE INDEX evidence_custody_events_incident_id_fk_idx ON public.evidence_custody_events (incident_id);
CREATE INDEX object_blobs_created_by_user_id_fk_idx ON public.object_blobs (created_by_user_id);

CREATE INDEX evidence_object_blob_id_fk_idx ON public.evidence (object_blob_id);

-- +goose Down
DROP TABLE public.evidence_access_handles ;
DROP TABLE public.evidence_custody_events ;
DROP TABLE public.evidence ;
DROP TABLE public.object_blobs ;
