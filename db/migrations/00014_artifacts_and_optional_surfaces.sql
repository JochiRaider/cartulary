-- +goose Up
--
-- Name: cartulary_confidence_band(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.artifact_findings
    ADD CONSTRAINT artifact_findings_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.artifact_findings
    ADD CONSTRAINT artifact_findings_owner_user_id_fkey FOREIGN KEY (owner_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.artifact_findings
    ADD CONSTRAINT artifact_findings_record_envelope_fkey FOREIGN KEY (incident_id, record_id) REFERENCES public.records(incident_id, record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.artifact_findings
    ADD CONSTRAINT artifact_findings_record_id_fkey FOREIGN KEY (record_id) REFERENCES public.artifacts(record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.artifact_forensic_keywords
    ADD CONSTRAINT artifact_forensic_keywords_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.artifact_forensic_keywords
    ADD CONSTRAINT artifact_forensic_keywords_record_envelope_fkey FOREIGN KEY (incident_id, record_id) REFERENCES public.records(incident_id, record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.artifact_forensic_keywords
    ADD CONSTRAINT artifact_forensic_keywords_record_id_fkey FOREIGN KEY (record_id) REFERENCES public.artifacts(record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.artifact_investigative_queries
    ADD CONSTRAINT artifact_investigative_queries_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.artifact_investigative_queries
    ADD CONSTRAINT artifact_investigative_queries_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.artifact_investigative_queries
    ADD CONSTRAINT artifact_investigative_queries_record_envelope_fkey FOREIGN KEY (incident_id, record_id) REFERENCES public.records(incident_id, record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.artifact_investigative_queries
    ADD CONSTRAINT artifact_investigative_queries_record_id_fkey FOREIGN KEY (record_id) REFERENCES public.artifacts(record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.artifacts
    ADD CONSTRAINT artifacts_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.artifacts
    ADD CONSTRAINT artifacts_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.artifacts
    ADD CONSTRAINT artifacts_incoming_owner_user_id_fkey FOREIGN KEY (incoming_owner_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.artifacts
    ADD CONSTRAINT artifacts_outgoing_owner_user_id_fkey FOREIGN KEY (outgoing_owner_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.artifacts
    ADD CONSTRAINT artifacts_record_envelope_fkey FOREIGN KEY (incident_id, record_id) REFERENCES public.records(incident_id, record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.artifacts
    ADD CONSTRAINT artifacts_review_owner_user_id_fkey FOREIGN KEY (review_owner_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.handoff_risk_refs
    ADD CONSTRAINT handoff_risk_refs_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.handoff_risk_refs
    ADD CONSTRAINT handoff_risk_refs_deleted_by_user_id_fkey FOREIGN KEY (deleted_by_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.handoff_risk_refs
    ADD CONSTRAINT handoff_risk_refs_handoff_fkey FOREIGN KEY (incident_id, handoff_record_id) REFERENCES public.records(incident_id, record_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.handoff_risk_refs
    ADD CONSTRAINT handoff_risk_refs_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;

-- +goose Down
DROP FUNCTION IF EXISTS public.cartulary_confidence_band(integer);
DROP TABLE IF EXISTS public.artifacts CASCADE;
DROP TABLE IF EXISTS public.artifact_findings CASCADE;
DROP TABLE IF EXISTS public.artifact_investigative_queries CASCADE;
DROP TABLE IF EXISTS public.artifact_forensic_keywords CASCADE;
DROP TABLE IF EXISTS public.handoff_risk_refs CASCADE;
