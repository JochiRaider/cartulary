...
ALTER TABLE ONLY public.reporting_job_payloads
    ADD CONSTRAINT reporting_job_payloads_actor_user_id_fkey FOREIGN KEY (actor_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.reporting_job_payloads
    ADD CONSTRAINT reporting_job_payloads_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.reporting_job_payloads
    ADD CONSTRAINT reporting_job_payloads_job_id_fkey FOREIGN KEY (job_id) REFERENCES public.jobs(job_id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.reporting_release_approvals
    ADD CONSTRAINT reporting_release_approvals_actor_user_id_fkey FOREIGN KEY (actor_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.reporting_release_approvals
    ADD CONSTRAINT reporting_release_approvals_release_id_fkey FOREIGN KEY (release_id) REFERENCES public.reporting_releases(release_id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.reporting_releases
    ADD CONSTRAINT reporting_releases_create_job_id_fkey FOREIGN KEY (create_job_id) REFERENCES public.jobs(job_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.reporting_releases
    ADD CONSTRAINT reporting_releases_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.reporting_releases
    ADD CONSTRAINT reporting_releases_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.reporting_releases
    ADD CONSTRAINT reporting_releases_snapshot_id_fkey FOREIGN KEY (snapshot_id) REFERENCES public.reporting_snapshots(snapshot_id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.reporting_render_bundle_files
    ADD CONSTRAINT reporting_render_bundle_files_release_id_fkey FOREIGN KEY (release_id) REFERENCES public.reporting_render_bundles(release_id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.reporting_render_bundles
    ADD CONSTRAINT reporting_render_bundles_release_id_fkey FOREIGN KEY (release_id) REFERENCES public.reporting_releases(release_id) ON UPDATE NO ACTION ON DELETE CASCADE;
...
ALTER TABLE ONLY public.reporting_snapshots
    ADD CONSTRAINT reporting_snapshots_create_job_id_fkey FOREIGN KEY (create_job_id) REFERENCES public.jobs(job_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.reporting_snapshots
    ADD CONSTRAINT reporting_snapshots_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE ONLY public.reporting_snapshots
    ADD CONSTRAINT reporting_snapshots_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON UPDATE NO ACTION ON DELETE CASCADE;

CREATE INDEX reporting_job_payloads_actor_user_id_fk_idx ON public.reporting_job_payloads (actor_user_id);
CREATE INDEX reporting_release_approvals_actor_user_id_fk_idx ON public.reporting_release_approvals (actor_user_id);
CREATE INDEX reporting_releases_create_job_id_fk_idx ON public.reporting_releases (create_job_id);
CREATE INDEX reporting_snapshots_create_job_id_fk_idx ON public.reporting_snapshots (create_job_id);

-- +goose Down

DROP TABLE public.reporting_release_approvals ;
DROP TABLE public.reporting_job_payloads ;
DROP TABLE public.reporting_render_bundle_files ;
DROP TABLE public.reporting_render_bundles ;
DROP TABLE public.reporting_releases ;
DROP TABLE public.reporting_snapshots ;
