...
ALTER TABLE ONLY public.incident_bundle_exports
    ADD CONSTRAINT incident_bundle_exports_export_job_id_fkey FOREIGN KEY (export_job_id) REFERENCES public.jobs(job_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.incident_bundle_exports
    ADD CONSTRAINT incident_bundle_exports_exported_by_user_id_fkey FOREIGN KEY (exported_by_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.incident_bundle_exports
    ADD CONSTRAINT incident_bundle_exports_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.incident_bundle_imported_actors
    ADD CONSTRAINT incident_bundle_imported_actors_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.incident_bundle_imported_actors
    ADD CONSTRAINT incident_bundle_imported_actors_local_user_id_fkey FOREIGN KEY (local_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.incident_bundle_imported_attributions
    ADD CONSTRAINT incident_bundle_imported_attributions_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.incident_bundle_imported_attributions
    ADD CONSTRAINT incident_bundle_imported_attributions_local_user_id_fkey FOREIGN KEY (local_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.incident_bundle_job_payloads
    ADD CONSTRAINT incident_bundle_job_payloads_actor_user_id_fkey FOREIGN KEY (actor_user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.incident_bundle_job_payloads
    ADD CONSTRAINT incident_bundle_job_payloads_incident_id_fkey FOREIGN KEY (incident_id) REFERENCES public.incidents(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.incident_bundle_job_payloads
    ADD CONSTRAINT incident_bundle_job_payloads_job_id_fkey FOREIGN KEY (job_id) REFERENCES public.jobs(job_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.incident_bundle_manifest_files
    ADD CONSTRAINT incident_bundle_manifest_files_bundle_id_fkey FOREIGN KEY (bundle_id) REFERENCES public.incident_bundle_exports(bundle_id) ON DELETE CASCADE;

-- +goose Down
DROP TABLE IF EXISTS public.incident_bundle_exports CASCADE;
DROP TABLE IF EXISTS public.incident_bundle_manifest_files CASCADE;
DROP TABLE IF EXISTS public.incident_bundle_job_payloads CASCADE;
DROP TABLE IF EXISTS public.incident_bundle_imported_actors CASCADE;
DROP TABLE IF EXISTS public.incident_bundle_imported_attributions CASCADE;
