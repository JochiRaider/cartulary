...
.PHONY: help help-all doctor bootstrap bootstrap-node-runtime frontend-toolchain frontend-install frontend-install-ci playwright-install db-up db-reset services-up services-wait postgres-wait minio-wait minio-init dev codegen-toolchain go-lint-toolchain go-security-toolchain generate generate-artifacts generate-drift toolchain-drift migration-drift deployable-shape phase-map-check phase-ledgers phase-ledger-drift phase-schedules phase-schedule-drift benchmark-claim-check task-surface-report task-guide phase-slice service-backed-slice task-surface-check backend-unit backend-store backend-integration backend-integration-support backend-process target-plan target-plan-json fixture-report explain-run explain-phase explain-target go-test-duration-baselines go-test-duration-baseline-coverage go-test-duration-baseline-drift browser-e2e-duration-baseline-drift service-backed-make-target-duration-baselines service-backed-make-target-duration-baseline-drift scheduler-event-order-drift backend-task-surface-check service-backed-unit-check test-service-images run-harness-smoke-fast run-harness-smoke-extended run-harness-smoke-full phase-test-name-check frontend-typecheck frontend-unit frontend-task-surface-check frontend-import-boundary-check lint-biome lint-scripts format format-go format-frontend browser-e2e browser-e2e-webserver-backed browser-e2e-functional browser-e2e-support browser-e2e-stateful browser-e2e-resettable browser-e2e-measurement browser-e2e-visual browser-e2e-task-surface-check test-local test-service-backed test-fast test-fast-service-backed test lint lint-go lint-go-format lint-go-vet lint-go-staticcheck go-vulncheck go-gosec-targeted go-gosec-audit check check-setup-blockers check-harness-smoke check-build-prereqs check-go-test-duration-baseline-drift check-browser-e2e-duration-baseline-drift check-service-backed-make-target-duration-baseline-drift check-frontend-unit check-service-backed ci release-check license-report sbom build build-server build-migrate build-web clean distclean
...
TASK_SURFACE_HELP_ALL_LINES := \
	...
	'  make lint                           run backend, frontend, and script lint/type checks' \
