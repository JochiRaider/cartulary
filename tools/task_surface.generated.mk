...
task-surface-report:
	$(Q)env NODE_BIN="$(NODE_BIN)" BASELINE_FILE="$(BASELINE_FILE)" CARTULARY_TEST_RESULTS_DIR="$(CARTULARY_TEST_RESULTS_DIR)" CARTULARY_TEST_RUN_ID="$(CARTULARY_TEST_RUN_ID)" DETAIL="$(DETAIL)" EXECUTION_TOPOLOGY_MANIFEST="$(EXECUTION_TOPOLOGY_MANIFEST)" FIXTURE_THRESHOLD_MS="$(FIXTURE_THRESHOLD_MS)" FIXTURE_TOP="$(FIXTURE_TOP)" JSON="$(JSON)" PHASE="$(PHASE)" PRUNE_OBSERVED_PACKAGES="$(PRUNE_OBSERVED_PACKAGES)" RESULTS_DIR="$(RESULTS_DIR)" ROLE="$(ROLE)" RUN_ID="$(RUN_ID)" SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE="$(SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE)" SERVICE_BACKED_SCHEDULE_MANIFEST="$(SERVICE_BACKED_SCHEDULE_MANIFEST)" TARGET="$(TARGET)" TASK_SURFACE_REPORT_ARGS="$(TASK_SURFACE_REPORT_ARGS)" ./scripts/run-make-node-tool.sh task-surface-report

task-guide:
	$(Q)env NODE_BIN="$(NODE_BIN)" BASELINE_FILE="$(BASELINE_FILE)" CARTULARY_TEST_RESULTS_DIR="$(CARTULARY_TEST_RESULTS_DIR)" CARTULARY_TEST_RUN_ID="$(CARTULARY_TEST_RUN_ID)" DETAIL="$(DETAIL)" EXECUTION_TOPOLOGY_MANIFEST="$(EXECUTION_TOPOLOGY_MANIFEST)" FIXTURE_THRESHOLD_MS="$(FIXTURE_THRESHOLD_MS)" FIXTURE_TOP="$(FIXTURE_TOP)" JSON="$(JSON)" PHASE="$(PHASE)" PRUNE_OBSERVED_PACKAGES="$(PRUNE_OBSERVED_PACKAGES)" RESULTS_DIR="$(RESULTS_DIR)" ROLE="$(ROLE)" RUN_ID="$(RUN_ID)" SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE="$(SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE)" SERVICE_BACKED_SCHEDULE_MANIFEST="$(SERVICE_BACKED_SCHEDULE_MANIFEST)" TARGET="$(TARGET)" TASK_SURFACE_REPORT_ARGS="$(TASK_SURFACE_REPORT_ARGS)" ./scripts/run-make-node-tool.sh task-guide

phase-slice:
	$(Q)env NODE_BIN="$(NODE_BIN)" BASELINE_FILE="$(BASELINE_FILE)" CARTULARY_TEST_RESULTS_DIR="$(CARTULARY_TEST_RESULTS_DIR)" CARTULARY_TEST_RUN_ID="$(CARTULARY_TEST_RUN_ID)" DETAIL="$(DETAIL)" EXECUTION_TOPOLOGY_MANIFEST="$(EXECUTION_TOPOLOGY_MANIFEST)" FIXTURE_THRESHOLD_MS="$(FIXTURE_THRESHOLD_MS)" FIXTURE_TOP="$(FIXTURE_TOP)" JSON="$(JSON)" PHASE="$(PHASE)" PRUNE_OBSERVED_PACKAGES="$(PRUNE_OBSERVED_PACKAGES)" RESULTS_DIR="$(RESULTS_DIR)" ROLE="$(ROLE)" RUN_ID="$(RUN_ID)" SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE="$(SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE)" SERVICE_BACKED_SCHEDULE_MANIFEST="$(SERVICE_BACKED_SCHEDULE_MANIFEST)" TARGET="$(TARGET)" TASK_SURFACE_REPORT_ARGS="$(TASK_SURFACE_REPORT_ARGS)" ./scripts/run-make-node-tool.sh phase-slice

service-backed-slice:
	$(Q)env NODE_BIN="$(NODE_BIN)" BASELINE_FILE="$(BASELINE_FILE)" CARTULARY_TEST_RESULTS_DIR="$(CARTULARY_TEST_RESULTS_DIR)" CARTULARY_TEST_RUN_ID="$(CARTULARY_TEST_RUN_ID)" DETAIL="$(DETAIL)" EXECUTION_TOPOLOGY_MANIFEST="$(EXECUTION_TOPOLOGY_MANIFEST)" FIXTURE_THRESHOLD_MS="$(FIXTURE_THRESHOLD_MS)" FIXTURE_TOP="$(FIXTURE_TOP)" JSON="$(JSON)" PHASE="$(PHASE)" PRUNE_OBSERVED_PACKAGES="$(PRUNE_OBSERVED_PACKAGES)" RESULTS_DIR="$(RESULTS_DIR)" ROLE="$(ROLE)" RUN_ID="$(RUN_ID)" SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE="$(SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE)" SERVICE_BACKED_SCHEDULE_MANIFEST="$(SERVICE_BACKED_SCHEDULE_MANIFEST)" TARGET="$(TARGET)" TASK_SURFACE_REPORT_ARGS="$(TASK_SURFACE_REPORT_ARGS)" ./scripts/run-make-node-tool.sh service-backed-slice

target-plan:
	$(Q)env NODE_BIN="$(NODE_BIN)" BASELINE_FILE="$(BASELINE_FILE)" CARTULARY_TEST_RESULTS_DIR="$(CARTULARY_TEST_RESULTS_DIR)" CARTULARY_TEST_RUN_ID="$(CARTULARY_TEST_RUN_ID)" DETAIL="$(DETAIL)" EXECUTION_TOPOLOGY_MANIFEST="$(EXECUTION_TOPOLOGY_MANIFEST)" FIXTURE_THRESHOLD_MS="$(FIXTURE_THRESHOLD_MS)" FIXTURE_TOP="$(FIXTURE_TOP)" JSON="$(JSON)" PHASE="$(PHASE)" PRUNE_OBSERVED_PACKAGES="$(PRUNE_OBSERVED_PACKAGES)" RESULTS_DIR="$(RESULTS_DIR)" ROLE="$(ROLE)" RUN_ID="$(RUN_ID)" SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE="$(SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE)" SERVICE_BACKED_SCHEDULE_MANIFEST="$(SERVICE_BACKED_SCHEDULE_MANIFEST)" TARGET="$(TARGET)" TASK_SURFACE_REPORT_ARGS="$(TASK_SURFACE_REPORT_ARGS)" ./scripts/run-make-node-tool.sh target-plan

target-plan-json:
	$(Q)env NODE_BIN="$(NODE_BIN)" BASELINE_FILE="$(BASELINE_FILE)" CARTULARY_TEST_RESULTS_DIR="$(CARTULARY_TEST_RESULTS_DIR)" CARTULARY_TEST_RUN_ID="$(CARTULARY_TEST_RUN_ID)" DETAIL="$(DETAIL)" EXECUTION_TOPOLOGY_MANIFEST="$(EXECUTION_TOPOLOGY_MANIFEST)" FIXTURE_THRESHOLD_MS="$(FIXTURE_THRESHOLD_MS)" FIXTURE_TOP="$(FIXTURE_TOP)" JSON="$(JSON)" PHASE="$(PHASE)" PRUNE_OBSERVED_PACKAGES="$(PRUNE_OBSERVED_PACKAGES)" RESULTS_DIR="$(RESULTS_DIR)" ROLE="$(ROLE)" RUN_ID="$(RUN_ID)" SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE="$(SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE)" SERVICE_BACKED_SCHEDULE_MANIFEST="$(SERVICE_BACKED_SCHEDULE_MANIFEST)" TARGET="$(TARGET)" TASK_SURFACE_REPORT_ARGS="$(TASK_SURFACE_REPORT_ARGS)" ./scripts/run-make-node-tool.sh target-plan-json

fixture-report:
	$(Q)env NODE_BIN="$(NODE_BIN)" BASELINE_FILE="$(BASELINE_FILE)" CARTULARY_TEST_RESULTS_DIR="$(CARTULARY_TEST_RESULTS_DIR)" CARTULARY_TEST_RUN_ID="$(CARTULARY_TEST_RUN_ID)" DETAIL="$(DETAIL)" EXECUTION_TOPOLOGY_MANIFEST="$(EXECUTION_TOPOLOGY_MANIFEST)" FIXTURE_THRESHOLD_MS="$(FIXTURE_THRESHOLD_MS)" FIXTURE_TOP="$(FIXTURE_TOP)" JSON="$(JSON)" PHASE="$(PHASE)" PRUNE_OBSERVED_PACKAGES="$(PRUNE_OBSERVED_PACKAGES)" RESULTS_DIR="$(RESULTS_DIR)" ROLE="$(ROLE)" RUN_ID="$(RUN_ID)" SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE="$(SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE)" SERVICE_BACKED_SCHEDULE_MANIFEST="$(SERVICE_BACKED_SCHEDULE_MANIFEST)" TARGET="$(TARGET)" TASK_SURFACE_REPORT_ARGS="$(TASK_SURFACE_REPORT_ARGS)" ./scripts/run-make-node-tool.sh fixture-report

explain-run:
	$(Q)env NODE_BIN="$(NODE_BIN)" BASELINE_FILE="$(BASELINE_FILE)" CARTULARY_TEST_RESULTS_DIR="$(CARTULARY_TEST_RESULTS_DIR)" CARTULARY_TEST_RUN_ID="$(CARTULARY_TEST_RUN_ID)" DETAIL="$(DETAIL)" EXECUTION_TOPOLOGY_MANIFEST="$(EXECUTION_TOPOLOGY_MANIFEST)" FIXTURE_THRESHOLD_MS="$(FIXTURE_THRESHOLD_MS)" FIXTURE_TOP="$(FIXTURE_TOP)" JSON="$(JSON)" PHASE="$(PHASE)" PRUNE_OBSERVED_PACKAGES="$(PRUNE_OBSERVED_PACKAGES)" RESULTS_DIR="$(RESULTS_DIR)" ROLE="$(ROLE)" RUN_ID="$(RUN_ID)" SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE="$(SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE)" SERVICE_BACKED_SCHEDULE_MANIFEST="$(SERVICE_BACKED_SCHEDULE_MANIFEST)" TARGET="$(TARGET)" TASK_SURFACE_REPORT_ARGS="$(TASK_SURFACE_REPORT_ARGS)" ./scripts/run-make-node-tool.sh explain-run

explain-phase:
	$(Q)env NODE_BIN="$(NODE_BIN)" BASELINE_FILE="$(BASELINE_FILE)" CARTULARY_TEST_RESULTS_DIR="$(CARTULARY_TEST_RESULTS_DIR)" CARTULARY_TEST_RUN_ID="$(CARTULARY_TEST_RUN_ID)" DETAIL="$(DETAIL)" EXECUTION_TOPOLOGY_MANIFEST="$(EXECUTION_TOPOLOGY_MANIFEST)" FIXTURE_THRESHOLD_MS="$(FIXTURE_THRESHOLD_MS)" FIXTURE_TOP="$(FIXTURE_TOP)" JSON="$(JSON)" PHASE="$(PHASE)" PRUNE_OBSERVED_PACKAGES="$(PRUNE_OBSERVED_PACKAGES)" RESULTS_DIR="$(RESULTS_DIR)" ROLE="$(ROLE)" RUN_ID="$(RUN_ID)" SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE="$(SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE)" SERVICE_BACKED_SCHEDULE_MANIFEST="$(SERVICE_BACKED_SCHEDULE_MANIFEST)" TARGET="$(TARGET)" TASK_SURFACE_REPORT_ARGS="$(TASK_SURFACE_REPORT_ARGS)" ./scripts/run-make-node-tool.sh explain-phase

explain-target:
	$(Q)env NODE_BIN="$(NODE_BIN)" BASELINE_FILE="$(BASELINE_FILE)" CARTULARY_TEST_RESULTS_DIR="$(CARTULARY_TEST_RESULTS_DIR)" CARTULARY_TEST_RUN_ID="$(CARTULARY_TEST_RUN_ID)" DETAIL="$(DETAIL)" EXECUTION_TOPOLOGY_MANIFEST="$(EXECUTION_TOPOLOGY_MANIFEST)" FIXTURE_THRESHOLD_MS="$(FIXTURE_THRESHOLD_MS)" FIXTURE_TOP="$(FIXTURE_TOP)" JSON="$(JSON)" PHASE="$(PHASE)" PRUNE_OBSERVED_PACKAGES="$(PRUNE_OBSERVED_PACKAGES)" RESULTS_DIR="$(RESULTS_DIR)" ROLE="$(ROLE)" RUN_ID="$(RUN_ID)" SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE="$(SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE)" SERVICE_BACKED_SCHEDULE_MANIFEST="$(SERVICE_BACKED_SCHEDULE_MANIFEST)" TARGET="$(TARGET)" TASK_SURFACE_REPORT_ARGS="$(TASK_SURFACE_REPORT_ARGS)" ./scripts/run-make-node-tool.sh explain-target

go-test-duration-baselines:
	$(Q)env NODE_BIN="$(NODE_BIN)" BASELINE_FILE="$(BASELINE_FILE)" CARTULARY_TEST_RESULTS_DIR="$(CARTULARY_TEST_RESULTS_DIR)" CARTULARY_TEST_RUN_ID="$(CARTULARY_TEST_RUN_ID)" DETAIL="$(DETAIL)" EXECUTION_TOPOLOGY_MANIFEST="$(EXECUTION_TOPOLOGY_MANIFEST)" FIXTURE_THRESHOLD_MS="$(FIXTURE_THRESHOLD_MS)" FIXTURE_TOP="$(FIXTURE_TOP)" JSON="$(JSON)" PHASE="$(PHASE)" PRUNE_OBSERVED_PACKAGES="$(PRUNE_OBSERVED_PACKAGES)" RESULTS_DIR="$(RESULTS_DIR)" ROLE="$(ROLE)" RUN_ID="$(RUN_ID)" SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE="$(SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE)" SERVICE_BACKED_SCHEDULE_MANIFEST="$(SERVICE_BACKED_SCHEDULE_MANIFEST)" TARGET="$(TARGET)" TASK_SURFACE_REPORT_ARGS="$(TASK_SURFACE_REPORT_ARGS)" ./scripts/run-make-node-tool.sh go-test-duration-baselines

go-test-duration-baseline-coverage:
	$(Q)env NODE_BIN="$(NODE_BIN)" BASELINE_FILE="$(BASELINE_FILE)" CARTULARY_TEST_RESULTS_DIR="$(CARTULARY_TEST_RESULTS_DIR)" CARTULARY_TEST_RUN_ID="$(CARTULARY_TEST_RUN_ID)" DETAIL="$(DETAIL)" EXECUTION_TOPOLOGY_MANIFEST="$(EXECUTION_TOPOLOGY_MANIFEST)" FIXTURE_THRESHOLD_MS="$(FIXTURE_THRESHOLD_MS)" FIXTURE_TOP="$(FIXTURE_TOP)" JSON="$(JSON)" PHASE="$(PHASE)" PRUNE_OBSERVED_PACKAGES="$(PRUNE_OBSERVED_PACKAGES)" RESULTS_DIR="$(RESULTS_DIR)" ROLE="$(ROLE)" RUN_ID="$(RUN_ID)" SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE="$(SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE)" SERVICE_BACKED_SCHEDULE_MANIFEST="$(SERVICE_BACKED_SCHEDULE_MANIFEST)" TARGET="$(TARGET)" TASK_SURFACE_REPORT_ARGS="$(TASK_SURFACE_REPORT_ARGS)" ./scripts/run-make-node-tool.sh go-test-duration-baseline-coverage

go-test-duration-baseline-drift:
	$(Q)env NODE_BIN="$(NODE_BIN)" BASELINE_FILE="$(BASELINE_FILE)" CARTULARY_TEST_RESULTS_DIR="$(CARTULARY_TEST_RESULTS_DIR)" CARTULARY_TEST_RUN_ID="$(CARTULARY_TEST_RUN_ID)" DETAIL="$(DETAIL)" EXECUTION_TOPOLOGY_MANIFEST="$(EXECUTION_TOPOLOGY_MANIFEST)" FIXTURE_THRESHOLD_MS="$(FIXTURE_THRESHOLD_MS)" FIXTURE_TOP="$(FIXTURE_TOP)" JSON="$(JSON)" PHASE="$(PHASE)" PRUNE_OBSERVED_PACKAGES="$(PRUNE_OBSERVED_PACKAGES)" RESULTS_DIR="$(RESULTS_DIR)" ROLE="$(ROLE)" RUN_ID="$(RUN_ID)" SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE="$(SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE)" SERVICE_BACKED_SCHEDULE_MANIFEST="$(SERVICE_BACKED_SCHEDULE_MANIFEST)" TARGET="$(TARGET)" TASK_SURFACE_REPORT_ARGS="$(TASK_SURFACE_REPORT_ARGS)" ./scripts/run-make-node-tool.sh go-test-duration-baseline-drift

browser-e2e-duration-baseline-drift:
	$(Q)env NODE_BIN="$(NODE_BIN)" BASELINE_FILE="$(BASELINE_FILE)" CARTULARY_TEST_RESULTS_DIR="$(CARTULARY_TEST_RESULTS_DIR)" CARTULARY_TEST_RUN_ID="$(CARTULARY_TEST_RUN_ID)" DETAIL="$(DETAIL)" EXECUTION_TOPOLOGY_MANIFEST="$(EXECUTION_TOPOLOGY_MANIFEST)" FIXTURE_THRESHOLD_MS="$(FIXTURE_THRESHOLD_MS)" FIXTURE_TOP="$(FIXTURE_TOP)" JSON="$(JSON)" PHASE="$(PHASE)" PRUNE_OBSERVED_PACKAGES="$(PRUNE_OBSERVED_PACKAGES)" RESULTS_DIR="$(RESULTS_DIR)" ROLE="$(ROLE)" RUN_ID="$(RUN_ID)" SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE="$(SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE)" SERVICE_BACKED_SCHEDULE_MANIFEST="$(SERVICE_BACKED_SCHEDULE_MANIFEST)" TARGET="$(TARGET)" TASK_SURFACE_REPORT_ARGS="$(TASK_SURFACE_REPORT_ARGS)" ./scripts/run-make-node-tool.sh browser-e2e-duration-baseline-drift

service-backed-make-target-duration-baselines:
	$(Q)env NODE_BIN="$(NODE_BIN)" BASELINE_FILE="$(BASELINE_FILE)" CARTULARY_TEST_RESULTS_DIR="$(CARTULARY_TEST_RESULTS_DIR)" CARTULARY_TEST_RUN_ID="$(CARTULARY_TEST_RUN_ID)" DETAIL="$(DETAIL)" EXECUTION_TOPOLOGY_MANIFEST="$(EXECUTION_TOPOLOGY_MANIFEST)" FIXTURE_THRESHOLD_MS="$(FIXTURE_THRESHOLD_MS)" FIXTURE_TOP="$(FIXTURE_TOP)" JSON="$(JSON)" PHASE="$(PHASE)" PRUNE_OBSERVED_PACKAGES="$(PRUNE_OBSERVED_PACKAGES)" RESULTS_DIR="$(RESULTS_DIR)" ROLE="$(ROLE)" RUN_ID="$(RUN_ID)" SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE="$(SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE)" SERVICE_BACKED_SCHEDULE_MANIFEST="$(SERVICE_BACKED_SCHEDULE_MANIFEST)" TARGET="$(TARGET)" TASK_SURFACE_REPORT_ARGS="$(TASK_SURFACE_REPORT_ARGS)" ./scripts/run-make-node-tool.sh service-backed-make-target-duration-baselines

service-backed-make-target-duration-baseline-drift:
	$(Q)env NODE_BIN="$(NODE_BIN)" BASELINE_FILE="$(BASELINE_FILE)" CARTULARY_TEST_RESULTS_DIR="$(CARTULARY_TEST_RESULTS_DIR)" CARTULARY_TEST_RUN_ID="$(CARTULARY_TEST_RUN_ID)" DETAIL="$(DETAIL)" EXECUTION_TOPOLOGY_MANIFEST="$(EXECUTION_TOPOLOGY_MANIFEST)" FIXTURE_THRESHOLD_MS="$(FIXTURE_THRESHOLD_MS)" FIXTURE_TOP="$(FIXTURE_TOP)" JSON="$(JSON)" PHASE="$(PHASE)" PRUNE_OBSERVED_PACKAGES="$(PRUNE_OBSERVED_PACKAGES)" RESULTS_DIR="$(RESULTS_DIR)" ROLE="$(ROLE)" RUN_ID="$(RUN_ID)" SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE="$(SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE)" SERVICE_BACKED_SCHEDULE_MANIFEST="$(SERVICE_BACKED_SCHEDULE_MANIFEST)" TARGET="$(TARGET)" TASK_SURFACE_REPORT_ARGS="$(TASK_SURFACE_REPORT_ARGS)" ./scripts/run-make-node-tool.sh service-backed-make-target-duration-baseline-drift

scheduler-event-order-drift:
	$(Q)env NODE_BIN="$(NODE_BIN)" BASELINE_FILE="$(BASELINE_FILE)" CARTULARY_TEST_RESULTS_DIR="$(CARTULARY_TEST_RESULTS_DIR)" CARTULARY_TEST_RUN_ID="$(CARTULARY_TEST_RUN_ID)" DETAIL="$(DETAIL)" EXECUTION_TOPOLOGY_MANIFEST="$(EXECUTION_TOPOLOGY_MANIFEST)" FIXTURE_THRESHOLD_MS="$(FIXTURE_THRESHOLD_MS)" FIXTURE_TOP="$(FIXTURE_TOP)" JSON="$(JSON)" PHASE="$(PHASE)" PRUNE_OBSERVED_PACKAGES="$(PRUNE_OBSERVED_PACKAGES)" RESULTS_DIR="$(RESULTS_DIR)" ROLE="$(ROLE)" RUN_ID="$(RUN_ID)" SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE="$(SERVICE_BACKED_MAKE_TARGET_DURATION_BASELINE)" SERVICE_BACKED_SCHEDULE_MANIFEST="$(SERVICE_BACKED_SCHEDULE_MANIFEST)" TARGET="$(TARGET)" TASK_SURFACE_REPORT_ARGS="$(TASK_SURFACE_REPORT_ARGS)" ./scripts/run-make-node-tool.sh scheduler-event-order-drift
