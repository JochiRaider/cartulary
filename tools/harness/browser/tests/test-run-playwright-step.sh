...
{"suites":[{"specs":[{"title":"raw success","file":"step4.spec.ts","tests":[{"results":[{"status":"passed","retry":0,"attachments":[],"errors":[]}]}]}],"suites":[]}],"errors":[]}
JSON
    ;;
  failure)
    cat >"\$output_file" <<'JSON'
{"suites":[{"specs":[{"title":"raw failure","file":"step4.spec.ts","tests":[{"results":[{"status":"failed","retry":0,"attachments":[{"name":"trace","path":"ATTACHMENT_FILE"}],"errors":[{"message":"Error: raw failure stack"}],"error":{"message":"Error: raw failure stack"}}]}]}],"suites":[]}],"errors":[]}
JSON
