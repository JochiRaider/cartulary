...
future_phases="$(
  CARTULARY_PHASE_MANIFEST_ROOT="$tmp_dir/manifests" \
    "$node_cmd" "$ROOT_DIR/tools/harness/phase-accounting/phase-manifest.mjs" playwright-phases authoritative browser_functional
)"
...
future_files="$(
  CARTULARY_PHASE_MANIFEST_ROOT="$tmp_dir/manifests" \
    "$node_cmd" "$ROOT_DIR/tools/harness/phase-accounting/phase-manifest.mjs" playwright-files-all authoritative browser_functional
)"
...
future_count="$(
  CARTULARY_PHASE_MANIFEST_ROOT="$tmp_dir/manifests" \
    "$node_cmd" "$ROOT_DIR/tools/harness/phase-accounting/phase-manifest.mjs" playwright-count-all authoritative browser_functional
)"
