...
|---|---|---|---|---|---|---|---|
| MSC-0001 | Test runtime reset route. | A destructive test-only route could be mistaken for public product API or production behavior. | Keep as harness-owned test hook only; do not make normative product behavior. | Maintainer decision recorded in `MD-S7-0004`; partial reset failure semantics remain source-limited. | `internal/testutil/testruntime/reset.go`; `AMB-0006`; `HAZ-S4-0007`; `RTR-0014`; `AUTH-0004`; `PRES-0010`; `MD-S7-0004` | `maintainer_decision/source_limit` | Core product routes remain owned by Core 01/Core 04. |
