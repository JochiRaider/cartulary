...
- **Status:** Complete. WS-00 through WS-17 passed their required gates, and the
  production-readiness cleanup iteration in Section 13 has no remaining implementation
  or validation slice.
- **Allowed change:** The current implementation request authorizes WS-12 through WS-17,
  subject to the mandatory tracker and validation gate after every workstream.
...
- **Implementation authorization:** Explicitly granted and completed on 2026-08-07 for
  WS-00 through WS-10. WS-11 was authorized as a documentation-only step; the current
  request explicitly authorizes WS-12 through WS-17.
...
| WS-11 | Rebaseline this tracker with the production-readiness cleanup iteration | WS-10 | DONE | Section 13 audit and plan; initial and post-status `make lint-markdown` runs `.cartulary/test-results/20260807T185329Z-p348875` and `.cartulary/test-results/20260807T185415Z-p350661` | WS-12 |
| WS-12 | Remove dead request-state projections | WS-11 | DONE | Format `.cartulary/test-results/20260807T190938Z-p362995`; config 15/15 `.cartulary/test-results/20260807T190948Z-p366208`; Extensions 37/37 `.cartulary/test-results/20260807T190948Z-p366216`; tracker lint `.cartulary/test-results/20260807T191119Z-p393143`; removed-symbol audit clean | WS-13 |
| WS-13 | Contract snapshots and owner presence to typed, namespace-scoped seams | WS-12 | DONE | Format `.cartulary/test-results/20260807T191456Z-p397767`; config 15/15 `.cartulary/test-results/20260807T191503Z-p400866`; telemetry 10/10 `.cartulary/test-results/20260807T191517Z-p405867`; OTel 14/14 `.cartulary/test-results/20260807T191517Z-p405748`; tracker lint `.cartulary/test-results/20260807T191617Z-p422953`; removed-symbol audit clean | WS-14 |
| WS-14 | Separate one-time structural admission from startup filesystem readiness | WS-13 | DONE | Format `.cartulary/test-results/20260807T191807Z-p427000`; config 15/15 `.cartulary/test-results/20260807T191816Z-p430074`; server 42/42 `.cartulary/test-results/20260807T191824Z-p434883`; tracker lint `.cartulary/test-results/20260807T191937Z-p466908`; production-wrapper audit clean | WS-15 |
| WS-15 | Remove test-only production admission and migrate application/test loading | WS-14 | DONE | Format `.cartulary/test-results/20260807T193313Z-p584552`; generate `.cartulary/test-results/20260807T193402Z-p613551`; tracker lint `.cartulary/test-results/20260807T194110Z-p851451`; affected unit/service-backed, builds, and browser evidence in Section 10; removed-symbol/tag audits clean | WS-16 |
| WS-16 | Enforce the contracted boundary and prune residual legacy support | WS-15 | DONE | Format `.cartulary/test-results/20260807T194432Z-p855890`; boundary 3/3 `.cartulary/test-results/20260807T194439Z-p858979`; tracker lint `.cartulary/test-results/20260807T194619Z-p863840`; harness/generation/policy/shape and exact audit evidence in Section 10 | WS-17 |
| WS-17 | Run final validation and complete the production-readiness handoff | WS-12 through WS-16 | DONE | Finalize `.cartulary/test-results/20260807T194722Z-p868706`; check 722/722 `.cartulary/test-results/20260807T200751Z-p1577549`; release 893/893 `.cartulary/test-results/20260807T201756Z-p1861671`; tracker lint `.cartulary/test-results/20260807T202746Z-p2026814`; complete matrix in Sections 10 and 13.8 | Complete |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 2026-08-07 16:25 EDT | Codex / WS-17 | The cleanup is complete: request state, snapshots, validation phases, application admission, test loading, and permanent boundary enforcement all use the contracted production-ready seams; every PRG row is closed and no compatibility path remains | Reconciled affected owners platform.config, platform.telemetry, module.extensions, app.server, app.operator, platform.postgres, module.recovery, plus the related module.evidence and module.networkflow harness rows; inspected all authored implementation/test/tooling/tracker changes and the one generated render-index digest; added one explicit test-route mode found by broad validation; domain vocabulary unchanged | Current task guides for seven affected owners; `make agent-finalize`; harness/generation/artifact/JSON/boundary/OTel checks; exact retired-symbol/tag/name/domain audits; unit and service-backed owner slices; server/migrate/operator builds; `make browser-e2e-stateful`; `make test-fast`; `make go-gosec-targeted`; `make check`; `make release-check`; failure diagnosis with `make explain-run`, `make explain-test-owner`, `make explain-target`, and exact row reruns; `make format`; `make lint-markdown`; `git diff --check`; `git status --short --branch` | PASS final matrix: finalize 1/1 `.cartulary/test-results/20260807T194722Z-p868706` with `results-dir-not-provided`; harness 2/2 `.cartulary/test-results/20260807T194742Z-p871590`; drift 4/4 `.cartulary/test-results/20260807T194742Z-p871370`; artifact policy 3/3 `.cartulary/test-results/20260807T194742Z-p871385`; JSON 3/3 `.cartulary/test-results/20260807T194757Z-p875010`; boundary 3/3 `.cartulary/test-results/20260807T194757Z-p875190`; OTel 14/14 `.cartulary/test-results/20260807T194757Z-p874926`; unit config 15/15 `.cartulary/test-results/20260807T194840Z-p886084`, telemetry 10/10 `.cartulary/test-results/20260807T194840Z-p886091`, Extensions 37/37 `.cartulary/test-results/20260807T194840Z-p886096`, server 42/42 `.cartulary/test-results/20260807T194926Z-p920501`, operator 17/17 `.cartulary/test-results/20260807T194926Z-p920504`, Postgres 9/9 `.cartulary/test-results/20260807T194926Z-p920520`, Recovery 37/37 `.cartulary/test-results/20260807T195014Z-p972261`; service Extensions 24/24 `.cartulary/test-results/20260807T195105Z-p1011064`, server 33/33 `.cartulary/test-results/20260807T195105Z-p1011063`, operator 9/9 `.cartulary/test-results/20260807T195105Z-p1011071`, Postgres 5/5 `.cartulary/test-results/20260807T195139Z-p1074848`, Recovery 25/25 `.cartulary/test-results/20260807T195139Z-p1074852`; builds server `.cartulary/test-results/20260807T195219Z-p1109614`, migrate `.cartulary/test-results/20260807T195219Z-p1109632`, operator `.cartulary/test-results/20260807T195219Z-p1109644`; browser 36/36 `.cartulary/test-results/20260807T195235Z-p1132464`; fast 349/349 `.cartulary/test-results/20260807T195435Z-p1158303`; gosec 4/4 `.cartulary/test-results/20260807T195649Z-p1223772`; check 722/722 `.cartulary/test-results/20260807T200751Z-p1577549`; release 893/893 `.cartulary/test-results/20260807T201756Z-p1861671`. Related check run `.cartulary/test-results/20260807T195703Z-p1249466` failed 721/722 because the WS-15 Evidence harness replacement omitted explicit disabled test-route mode; format `.cartulary/test-results/20260807T200123Z-p1393099` and exact row 3/3 `.cartulary/test-results/20260807T200133Z-p1396151` prove the repair. Check run `.cartulary/test-results/20260807T200203Z-p1397916` and release run `.cartulary/test-results/20260807T200901Z-p1653049` each failed one server-process reset request at the two-second client deadline under broad load; their exact rows passed 7/7 at `.cartulary/test-results/20260807T200716Z-p1558137` and `.cartulary/test-results/20260807T201723Z-p1842335` without code changes before the passing broad reruns. One initial broad symbol audit matched the retained truth-table test name and was corrected to exact type/qualified symbols; one log-search invocation had invalid `rg` option ordering and was corrected immediately. No failure or required command is omitted, and no unrelated exception is taken. | None. External deployment v2, keys, claims, discovery, overlays, defaults, diagnostics, startup order, HTTP/database/browser contracts, and product data remain unchanged. Internal Go/test APIs intentionally break without aliases. Only the authored selector rename generated a render-index digest update; no production generated artifact changed. No known residual product or migration risk remains. | Complete after the final tracker Markdown, diff, and status gate. |
| 2026-08-07 15:45 EDT | Codex / WS-16 | Authored source boundaries now reject reintroduction of full-document/snapshot decode, reflective document or owner cloning, in-memory TOML snapshot admission, configassembly in-memory admission, and TOML-tagged `Deployment`; the extension policy filenames match their complete responsibility | Renamed platform-config policy and test-support files to `extension_policy` names; updated authored backend boundary policy and checker self-fixtures; retained generic `NamespaceDecoder`, typed overlay reflection, live inactive-value reflection, and owner `Clone`; no authored selector or generated artifact changed; domain vocabulary unchanged | `make format`; `make backend-module-boundary-check`; `make harness-contract`; `make generate-drift`; `make generated-artifact-policy-check`; `make json-shape-check`; exact retired-symbol, TOML-tag, stale-filename, and retained-seam audits; `make lint-markdown` | PASS: format `.cartulary/test-results/20260807T194432Z-p855890`; boundary 3/3 `.cartulary/test-results/20260807T194439Z-p858979`; harness 2/2 `.cartulary/test-results/20260807T194452Z-p859651`; drift 4/4 `.cartulary/test-results/20260807T194452Z-p859434`; generated-artifact policy 3/3 `.cartulary/test-results/20260807T194452Z-p859447`; JSON shape 3/3 `.cartulary/test-results/20260807T194503Z-p862981`; tracker lint `.cartulary/test-results/20260807T194619Z-p863840`; exact retired-symbol/tag/name audits empty and retained seam audit found the expected namespace decoder, overlay reflection, and owner clones. Negative self-fixtures each produce exactly one forbidden-source violation; supported fixtures produce none. No generated output changed in WS-16. External behavior and runtime compatibility are unchanged; future internal development now fails closed on the retired seams. | None; the token rules are scoped to exact identifiers and paths and did not reject live decoder/overlay/clone behavior. | Begin WS-17 after the Markdown gate. |
| 2026-08-07 15:40 EDT | Codex / WS-15 | Production composition accepts only an admitted `configassembly.Loaded`; application loading exposes only path/environment inputs; test and recovery harness variants are artifacts plus pre-admission overlays; `Deployment` is a defensive projection rather than a TOML DTO | Updated configassembly, server/migrate/operator composition, telemetry admission tests, configtest/appsupport/httptestx and recovery/browser harnesses, affected owner tests, and the authored platform.config selector; generated only the execution-topology render index; removed in-memory admission, projection TOML tags, post-admission mutators, duplicate loader/server helpers, and `LoadSnapshotFromTOML`; domain vocabulary unchanged | `make format`; `make generate`; exact retired API/tag/caller audits; `make build-server`; `make build-migrate`; `make build-operator`; unit slices for platform.config, platform.telemetry, module.extensions, app.server, app.operator, platform.postgres, and module.recovery; service-backed slices for module.extensions, app.server, app.operator, platform.postgres, and module.recovery; `make browser-e2e-stateful`; `make lint-markdown` | PASS: final format `.cartulary/test-results/20260807T193313Z-p584552`; generate `.cartulary/test-results/20260807T193402Z-p613551`; builds server `.cartulary/test-results/20260807T193023Z-p516461`, migrate `.cartulary/test-results/20260807T193423Z-p616464`, operator `.cartulary/test-results/20260807T193423Z-p616468`; unit config 15/15 `.cartulary/test-results/20260807T193423Z-p616163`, telemetry 10/10 `.cartulary/test-results/20260807T193548Z-p695544`, Extensions 37/37 `.cartulary/test-results/20260807T193548Z-p695548`, server 42/42 `.cartulary/test-results/20260807T193323Z-p587635`, operator 17/17 `.cartulary/test-results/20260807T193448Z-p631011`, Postgres 9/9 `.cartulary/test-results/20260807T193448Z-p631027`, Recovery 37/37 `.cartulary/test-results/20260807T193448Z-p631014`; service Extensions 24/24 `.cartulary/test-results/20260807T193630Z-p726894`, server 33/33 `.cartulary/test-results/20260807T193630Z-p726899`, operator 9/9 `.cartulary/test-results/20260807T193704Z-p771511`, Postgres 5/5 `.cartulary/test-results/20260807T193704Z-p771514`, Recovery 25/25 `.cartulary/test-results/20260807T193727Z-p792501`; browser 36/36 `.cartulary/test-results/20260807T193803Z-p825085`; tracker lint `.cartulary/test-results/20260807T194110Z-p851451`; retired symbol/tag audits empty. Related server runs `.cartulary/test-results/20260807T192907Z-p478898`, `.cartulary/test-results/20260807T193036Z-p527150`, and `.cartulary/test-results/20260807T193155Z-p557233` failed respectively on stale imports, an empty-string bootstrap overlay plus missing runtime secret propagation, and an omission represented as an unreadable path; each cause was repaired structurally before the passing 42/42 result. External deployment v2, diagnostics, startup order, borrowed-resource ownership, service bindings, and browser restore posture remain unchanged. The selector rename retains its existing row ID/owner; only the generated render-index digest changed. | None; no normative contradiction or compatibility exception was found. | Begin WS-16 after the Markdown gate. |
| 2026-08-07 15:19 EDT | Codex / WS-14 | Structural validation runs only while admitting the artifact; startup accepts only an admitted snapshot and performs filesystem canonicalization, overlap, and writability readiness; zero snapshots fail deterministically; direct document-validation conveniences exist only in `_test.go` | Updated platform-config snapshot/startup validation and test support; retained existing server startup and diagnostic-golden ownership; domain vocabulary unchanged | `make format`; exact production-wrapper search; `make test-slice OWNER=platform.config`; `make test-slice OWNER=app.server`; `make lint-markdown` | PASS: format `.cartulary/test-results/20260807T191807Z-p427000`; config 15/15 `.cartulary/test-results/20260807T191816Z-p430074`; server 42/42 `.cartulary/test-results/20260807T191824Z-p434883`; tracker lint `.cartulary/test-results/20260807T191937Z-p466908`; production `validate*` wrapper audit empty. Accepted artifacts and existing diagnostic ordering are unchanged; only internal zero-snapshot misuse gains a fail-closed invariant error. | None | Begin WS-15. |
| 2026-08-07 15:15 EDT | Codex / WS-13 | An admitted snapshot retains only typed Core 04 state, sorted requested-claim registration IDs, and owner values protected by owner `Clone`; each contribution receives presence only for its own registered namespace; the decoded document and reflection-copy path end at materialization | Updated platform-config catalog/snapshot and lifecycle tests, configassembly Core projection, telemetry contribution, and owner fixture registrations; domain vocabulary unchanged | `make format`; `make test-slice OWNER=platform.config`; `make test-slice OWNER=platform.telemetry`; `make otel-conformance`; exact removed-symbol searches; `make lint-markdown` | PASS: format `.cartulary/test-results/20260807T191456Z-p397767`; config 15/15 `.cartulary/test-results/20260807T191503Z-p400866`; telemetry 10/10 `.cartulary/test-results/20260807T191517Z-p405867`; OTel 14/14 `.cartulary/test-results/20260807T191517Z-p405748`; tracker lint `.cartulary/test-results/20260807T191617Z-p422953`; `Source`, arbitrary snapshot decode, document copy, and reflective clone audits empty. External TOML, overlays, diagnostics, and OTel semantics are unchanged; internal snapshot/catalog APIs intentionally break without aliases. | None | Begin WS-14. |
| 2026-08-07 15:10 EDT | Codex / WS-12 | `Loaded.RequestedClaims()` is the sole request-state projection; four unused claim-only `Deployment` fields, their transient requested-set map, and `extensionassembly.ClaimConfiguration` are removed without changing generated registrations or owner configuration | Updated configassembly deployment projection and Extensions configuration assembly; inspected claim truth-table and caller evidence; domain vocabulary unchanged | `make format`; exact `ClaimConfiguration`, claim-field, and requested-set searches; `make test-slice OWNER=platform.config`; `make test-slice OWNER=module.extensions`; `make lint-markdown` | PASS: format `.cartulary/test-results/20260807T190938Z-p362995`; config 15/15 `.cartulary/test-results/20260807T190948Z-p366208`; Extensions 37/37 `.cartulary/test-results/20260807T190948Z-p366216`; tracker lint `.cartulary/test-results/20260807T191119Z-p393143`; removed-symbol audit empty. External deployment-config v2 claim keys and omitted/false/true behavior are unchanged; the internal duplicate projection is intentionally removed without an alias. | None | Begin WS-13. |
...
| RB-005 | Is the production-readiness cleanup implementation authorized? | The earlier request was explicitly a document-update step; treating it as production authorization would have bypassed the new per-workstream gates. | A later explicit implementation request covering WS-12 through WS-17 | RESOLVED — the current implementation request explicitly authorizes WS-12 through WS-17 and retains every per-workstream gate. |

There is no active product, specification, release, or authorization blocker and no
approval exception against the completed prior iteration. Historical planning labels in
Sections 2 through 8 are retained only to explain the decisions that the authorized
WS-00 through WS-10 sequence superseded.
...
| --- | --- | --- | --- | --- | --- | --- |
| PRG-001 | **CLOSED by WS-12.** `Loaded.RequestedClaims()` is the only request-state projection; the four claim-only deployment fields and `ClaimConfiguration` are absent. | **Implementation and tests:** remove the four fields, their construction map, and `ClaimConfiguration`. Keep `Loaded.RequestedClaims()` as the only request-state projection. | Removes a second representation of requested claims and preserves the security distinction between deployment settings, requested claims, resolved claims, and published identity. New claim-only profiles no longer require application projection edits. | Intentional internal Go break with atomic caller/test updates and no alias. Operator-facing claim keys remain accepted through the generated claim policy. | A Boolean mirror could be treated as resolved authority, and each future profile could recreate a central static projection list. | Satisfied: removed-symbol searches are empty; current claim truth-table and Extensions/configassembly tests pass; requested claims remain unchanged for omitted, false, and true values. |
| PRG-002 | **CLOSED by WS-13.** Snapshots retain only typed Core state, sorted request IDs, and owner-cloned values; namespace presence is mechanically scoped and arbitrary document access is absent. | **Implementation and tests:** add `CoreConfiguration` and defensive `Snapshot.Core()`; replace `Source` with presence-only `NamespacePresence`; store only Core configuration, sorted requested-claim IDs, and owner-cloned values in snapshots; remove arbitrary document decode and reflection-based document/owner cloning. | Gives the kernel a typed, closed projection and prevents owners from inspecting or copying unrelated namespaces. Owner-provided clone behavior becomes the only authority for owner values, making future map/slice/private-field types safe. | Internal catalog and snapshot API broke atomically. Configassembly and telemetry migrated together; TOML shape and diagnostics remain unchanged. | Full-document access could become an accidental compatibility surface, namespace isolation could remain advisory, and reflection could silently mishandle future owner types. | Satisfied: a fixture owner observes presence only inside its registered namespace; `Snapshot.Core()` and `Value` are defensive; no removed helper remains; platform-config, telemetry, and OTel checks pass. |
| PRG-003 | **CLOSED by WS-14.** Structural admission runs once, startup accepts only admitted snapshots and performs filesystem readiness, and structural test conveniences are test-only. | **Implementation and tests:** run structural validation exactly once during admission; make startup validation reject an unadmitted snapshot and perform only filesystem canonicalization, overlap, and writability readiness checks; migrate tests to the production loader or narrow `_test.go` helpers around the production structural validator. | Establishes one owner for each validation phase, removes phase drift, and avoids reapplying defaults or validating with an incomplete policy. | No accepted input or diagnostic changed. Tests stopped depending on production-only wrappers and private document lifecycle shortcuts. | Structural behavior could diverge by call path, and an invalid zero snapshot could be mistaken for admitted input after simplification. | Satisfied: structurally invalid input never yields a snapshot; zero/unadmitted snapshots fail closed; admitted startup diagnostics and ordering match the baseline; wrappers have no production references. |
| PRG-004 | **CLOSED by WS-15.** Production and test callers have no in-memory admission API, runtime accepts only `Loaded`, `Deployment` has no wire tags, and repository harness variants load artifacts plus overlays. | **Implementation and test support:** remove both in-memory admission APIs; make `server.NewRuntime` accept `configassembly.Loaded`; consolidate explicit path and fixture loading in `internal/testutil/configtest`; construct test variants through valid TOML fixtures plus explicit overlays; remove `Deployment` TOML tags and the duplicate appsupport loader. | Makes production construction consume admitted state only and ensures integration tests exercise the same discovery, overlay, catalog, and policy path as binaries. The application projection ceases pretending to be a wire DTO. | Intentional internal Go/test-harness break. Server, migrate, operator, recovery, HTTP test harness, and runtime tests migrated atomically. No serialization shim is retained. | Tests could normalize or admit shapes that production never accepts, and test convenience could define production APIs and projection metadata. | Satisfied: no production API accepts an unadmitted `Deployment`; no test serializes `Deployment`; removed symbols/tags have no callers; affected builds and owner/service-backed/stateful slices pass. |
| PRG-005 | **CLOSED by WS-15.** `configassembly.LoadOptions` contains only `Path` and `Env`; application assembly constructs the kernel options and mandatory generated policy internally. | **Implementation and tests:** add `configassembly.LoadOptions { Path string; Env map[string]string }` and construct kernel `config.LoadOptions` plus the generated policy inside application assembly. | Makes application assembly's accepted inputs truthful and prevents generic kernel policy details from leaking into composition roots or tests. | Internal call sites migrated atomically. Platform `config.LoadOptions` remains the kernel input and retains its policy field for the explicit assembly edge. | A caller could believe it selected admission policy while application assembly silently substituted another, obscuring ownership and tests. | Satisfied: no caller passes platform options to configassembly; path/env behavior and mandatory fail-closed generated policy are covered by the passing owner matrix. |
| PRG-006 | **CLOSED by WS-16.** Authored forbidden-source rules and self-fixtures cover every retired access/admission/wire seam; extension-policy filenames match the current abstraction; exact residual audits are empty. | **Tooling, implementation hygiene, and tests:** extend the authored backend boundary with negative fixtures for the removed access/admission forms; rename stale policy filenames; prune obsolete helpers and imports. | Converts cleanup decisions into durable architecture rules and leaves names aligned with current responsibility, reducing the chance that later work revives the legacy seam. | Boundary policy is stricter for future internal changes. No runtime or product compatibility impact. | Without enforcement, the repository could regress to the same bypasses while all behavioral tests remained green, and stale names could mislead future maintainers. | Satisfied: representative forbidden fixtures fail, supported decoder/overlay/clone fixtures pass, boundary is 3/3, generation drift is 4/4, and exact symbol/name searches are clean. |
...
- **Status:** DONE on 2026-08-07; PRG-001 is closed with the evidence recorded in
  Sections 1.1 and 10.
...
- **Status:** DONE on 2026-08-07; PRG-002 is closed with the evidence recorded in
  Sections 1.1 and 10.
...
- **Status:** DONE on 2026-08-07; PRG-003 is closed with the evidence recorded in
  Sections 1.1 and 10.
...
- **Status:** DONE on 2026-08-07; PRG-004 and PRG-005 are closed with the evidence
  recorded in Sections 1.1 and 10.
...
- **Status:** DONE on 2026-08-07; PRG-006 is closed with the evidence recorded in
  Sections 1.1 and 10.
...
- **Status:** DONE on 2026-08-07; every PRG row is closed and the complete validation
  and compatibility handoff is recorded in Sections 10 and 13.8.
...
### 13.8 Current iteration final handoff

WS-12 through WS-17 are complete. The final implementation has these durable
boundaries:

1. `Loaded.RequestedClaims()` is the sole request-state projection. Requested claims,
   resolved claims, and resolved-claim-set identity remain separate typed values.
2. An admitted snapshot exposes defensive typed Core state and owner-cloned values only.
   Namespace presence is mechanically scoped; the decoded artifact and global presence
   map end at materialization.
3. Structural validation owns admission exactly once. Startup accepts admitted state
   only and owns filesystem canonicalization, overlap, and writability readiness.
4. Application/runtime and test harness composition consume `configassembly.Loaded`.
   Variants use artifact discovery plus overlays before admission, and application
   loading accepts only truthful path/environment options.
5. Authored backend boundaries reject every retired access, admission, reflection-copy,
   and projection-wire seam while preserving generic decoding, typed overlays, live
   inactive-value traversal, and owner cloning.

#### Validation result

| Gate | Final result and evidence |
| --- | --- |
| Finalization | 1/1, `.cartulary/test-results/20260807T194722Z-p868706`; retained-run maintenance recorded `results-dir-not-provided` |
| Harness, generation, artifact, JSON, boundary | 2/2, 4/4, 3/3, 3/3, and 3/3; roots `.cartulary/test-results/20260807T194742Z-p871590`, `.cartulary/test-results/20260807T194742Z-p871370`, `.cartulary/test-results/20260807T194742Z-p871385`, `.cartulary/test-results/20260807T194757Z-p875010`, `.cartulary/test-results/20260807T194757Z-p875190` |
| Platform config, telemetry, OTel | 15/15, 10/10, and 14/14; roots `.cartulary/test-results/20260807T194840Z-p886084`, `.cartulary/test-results/20260807T194840Z-p886091`, `.cartulary/test-results/20260807T194757Z-p874926` |
| Extensions unit/service | 37/37 and 24/24; roots `.cartulary/test-results/20260807T194840Z-p886096`, `.cartulary/test-results/20260807T195105Z-p1011064` |
| Server unit/service | 42/42 and 33/33; roots `.cartulary/test-results/20260807T194926Z-p920501`, `.cartulary/test-results/20260807T195105Z-p1011063` |
| Operator unit/service | 17/17 and 9/9; roots `.cartulary/test-results/20260807T194926Z-p920504`, `.cartulary/test-results/20260807T195105Z-p1011071` |
| Postgres unit/service | 9/9 and 5/5; roots `.cartulary/test-results/20260807T194926Z-p920520`, `.cartulary/test-results/20260807T195139Z-p1074848` |
| Recovery unit/service | 37/37 and 25/25; roots `.cartulary/test-results/20260807T195014Z-p972261`, `.cartulary/test-results/20260807T195139Z-p1074852` |
| Server, migrate, operator builds | PASS; roots `.cartulary/test-results/20260807T195219Z-p1109614`, `.cartulary/test-results/20260807T195219Z-p1109632`, `.cartulary/test-results/20260807T195219Z-p1109644` |
| Stateful browser | 36/36, `.cartulary/test-results/20260807T195235Z-p1132464` |
| Fast and targeted security | 349/349 and 4/4; roots `.cartulary/test-results/20260807T195435Z-p1158303`, `.cartulary/test-results/20260807T195649Z-p1223772` |
| Full check | 722/722, `.cartulary/test-results/20260807T200751Z-p1577549` |
| Release check | 893/893, `.cartulary/test-results/20260807T201756Z-p1861671` |
| Tracker Markdown | PASS, `.cartulary/test-results/20260807T202746Z-p2026814` |

All failed attempts and their resolutions are recorded in the WS-17 Section 10 row. No
unrelated failure exception or skipped required gate is used.

#### Compatibility, generated artifacts, and residual risk

- `cartulary.deployment_config.v2`, supported keys and claim paths, artifact discovery,
  overlay precedence, defaults, diagnostics, secret handling, readiness, and fail-closed
  startup behavior are unchanged.
- No database, HTTP, browser, deployment-schema, product-data, or normative
  specification migration is introduced. `docs/domain.md` is unchanged.
- Removed internal Go and test-harness APIs have no alias, shim, builder, compatibility
  reader, serialized projection, or dual path. Repository callers migrated atomically.
- The authored platform.config selector retains its row ID and owner while naming the
  artifact-admission test. `make generate` changed only the generated execution-topology
  render-index input hash; no production generated artifact changed.
- No known residual product, security, compatibility, or migration risk remains. The
  continuing maintenance obligation is enforced by the authored boundary rules: new
  owners and profiles must use static catalog contributions, admitted snapshots,
  namespace-scoped presence, owner cloning, and pre-admission overlays.
