...
| Harness controls | `internal/platform/httpapi/testclock.go`; `internal/platform/harnessruntime/public_error_fault.go`; `internal/platform/harnessruntime/reset.go` | Test clock and one-shot public error exist; required commit/worker/randomness controls do not |
...
| `NFA-HANDOFF-001` | Session handoff and next-slice bootstrap | handoff | `DONE` | current session | tracker maintainer | tracker ACs | §§14–17 | Final handoff closeout in §15.43; retained full check `.cartulary/test-results/20260710T160410Z-p37044`; finalizer `.cartulary/test-results/20260710T160629Z-p38728` | `make check`; `make agent-finalize RESULTS_DIR=.cartulary/test-results/20260710T160410Z-p37044`; final tracker checks in §15.43 | Another agent can resume from the completed adoption state without discovery |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `NF-AC-001` | Unclaimed tab and routes unavailable. | browser + route integration | See `tools/phase12_test_map.json` row for `NF-AC-001` | n/a: claim-state scenario | `NFA-C00-001`; `NFA-C01-001`; `NFA-C03-001`; `NFA-C04-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-001` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-002` | Claimed empty state and authorized import action. | browser | See `tools/phase12_test_map.json` row for `NF-AC-002` | n/a: claim/role scenario | `NFA-C00-001`; `NFA-C03-001`; `NFA-C04-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-002` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-003` | Core envelopes and unknown-member rejection. | contract + route integration | See `tools/phase12_test_map.json` row for `NF-AC-003` | `NF-FIX-010-json-admission` | `NFA-C01-004`; `NFA-C04-001`; `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-003` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-004` | Duplicate JSON members rejected before mutation/idempotency. | parser + integration | See `tools/phase12_test_map.json` row for `NF-AC-004` | `NF-FIX-010-json-admission` | `NFA-C01-005`; `NFA-TH-002`; `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-004` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-005` | UTF-8, JSON, object, null, and member admission is deterministic. | parser + route integration | See `tools/phase12_test_map.json` row for `NF-AC-005` | `NF-FIX-010-json-admission` | `NFA-GEN-001`; `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-005` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-006` | Minimal import creates one table and inner tab. | integration + browser | See `tools/phase12_test_map.json` row for `NF-AC-006` | `NF-FIX-001-cisco-sna-minimal` | `NFA-C01-003..005`; `NFA-C03-001`; `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-006` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-007` | Filename-derived display naming and suffixing. | unit + integration | See `tools/phase12_test_map.json` row for `NF-AC-007` | `NF-FIX-013-filename-display` | `NFA-C01-003`; `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-007` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-008` | Apply replay returns same table without duplicate. | transactional integration | See `tools/phase12_test_map.json` row for `NF-AC-008` | `NF-FIX-020-atomic-import-commit` | `NFA-C01-004..005`; `NFA-TH-002` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-008` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-009` | Duplicate headers use source ordinals. | parser + integration | See `tools/phase12_test_map.json` row for `NF-AC-009` | `NF-FIX-003-duplicate-headers` | `NFA-C01-003`; `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-009` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-010` | Cisco SNA required fields enforced. | parser conformance | See `tools/phase12_test_map.json` row for `NF-AC-010` | `NF-FIX-001-cisco-sna-minimal`; `NF-FIX-004-rejected-rows` | `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-010` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-011` | Reserved profiles cannot be claimed. | contract + integration | See `tools/phase12_test_map.json` row for `NF-AC-011` | n/a: source-profile vectors | `NFA-C00-001`; `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-011` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-012` | CSV edge cases follow exact parser outcomes. | parser conformance | See `tools/phase12_test_map.json` row for `NF-AC-012` | `NF-FIX-005-csv-parser-edges`; `NF-FIX-021-preview-boundaries` | `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-012` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-013` | Formula-looking values remain inert. | parser + security | See `tools/phase12_test_map.json` row for `NF-AC-013` | `NF-FIX-005-csv-parser-edges` | `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-013` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-014` | Invalid rows yield deterministic diagnostics and no query/graph rows. | integration | See `tools/phase12_test_map.json` row for `NF-AC-014` | `NF-FIX-004-rejected-rows` | `NFA-GP-001`; `NFA-TH-004` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-014` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-015` | Partly valid import retains accepted rows and rejected count. | integration | See `tools/phase12_test_map.json` row for `NF-AC-015` | `NF-FIX-004-rejected-rows` | `NFA-C01-004`; `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-015` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-016` | All-invalid import creates no table. | transactional integration | See `tools/phase12_test_map.json` row for `NF-AC-016` | `NF-FIX-004-rejected-rows` | `NFA-C01-004`; `NFA-TH-002` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-016` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-017` | Five digest/ID algorithms match exact vectors. | unit + fixture conformance | See `tools/phase12_test_map.json` row for `NF-AC-017` | `NF-FIX-001-cisco-sna-minimal`; `NF-FIX-006-cross-table-graph`; `NF-FIX-019-canonical-json-unicode` | `NFA-LOC-001`; `NFA-TH-004` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-017` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-018` | Timestamp folds, gaps, leap seconds, inference, and reversed intervals reject. | unit + fixture conformance | See `tools/phase12_test_map.json` row for `NF-AC-018` | `NF-FIX-004-rejected-rows`; `NF-FIX-012-sys-uptime-timestamps`; `NF-FIX-022-timestamp-rulesets` | `NFA-TZ-001`; `NFA-TH-003` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-018` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-019` | Canonical IP output and invalid forms. | unit conformance | See `tools/phase12_test_map.json` row for `NF-AC-019` | `NF-FIX-004-rejected-rows`; `NF-FIX-017-indicator-link-mismatch` | `NFA-C02-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-019` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-020` | Unsigned-decimal grammar and max bound. | unit conformance | See `tools/phase12_test_map.json` row for `NF-AC-020` | `NF-FIX-004-rejected-rows`; `NF-FIX-028-graph-aggregate-bounds` | `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-020` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-021` | Table lifecycle excludes renamed state. | structural + state-machine unit | See `tools/phase12_test_map.json` row for `NF-AC-021` | n/a: structural | `NFA-GEN-001`; `NFA-VAL-002` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-021` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-022` | Rename changes metadata/version only and preserves identities/cursors/bindings. | transactional integration | See `tools/phase12_test_map.json` row for `NF-AC-022` | `NF-FIX-013-filename-display`; `NF-FIX-014-cursor-pagination` | `NFA-C01-004`; `NFA-C04-002`; `NFA-TH-002` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-022` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-023` | Soft delete hides table and invalidates graph/cursors terminally. | integration + browser | See `tools/phase12_test_map.json` row for `NF-AC-023` | `NF-FIX-009-soft-delete-stale-graph`; `NF-FIX-027-retention-soft-delete` | `NFA-C03-002`; `NFA-C04-002`; `NFA-C04-005` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-023` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-024` | Filters use field keys and reject visible labels. | contract + integration | See `tools/phase12_test_map.json` row for `NF-AC-024` | `NF-FIX-024-query-normalization-cursors` | `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-024` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-025` | Filter `in` rejects duplicate/empty values. | unit + route integration | See `tools/phase12_test_map.json` row for `NF-AC-025` | `NF-FIX-024-query-normalization-cursors` | `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-025` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-026` | CIDR rejects family mismatch and mapped-family coercion. | unit conformance | See `tools/phase12_test_map.json` row for `NF-AC-026` | `NF-FIX-024-query-normalization-cursors` | `NFA-C02-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-026` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-027` | Sort semantics and default tail are exact. | integration | See `tools/phase12_test_map.json` row for `NF-AC-027` | `NF-FIX-014-cursor-pagination`; `NF-FIX-024-query-normalization-cursors` | `NFA-C04-002`; `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-027` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-028` | Cursor invalidation covers TTL, actor, route, query, delete, and auth loss. | security + integration | See `tools/phase12_test_map.json` row for `NF-AC-028` | `NF-FIX-009-soft-delete-stale-graph`; `NF-FIX-014-cursor-pagination`; `NF-FIX-024-query-normalization-cursors` | `NFA-C04-002`; `NFA-C03-002`; `NFA-TH-003`; `NFA-TH-005` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-028` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-029` | Graph filter selector exposes table-selection controls. | browser | See `tools/phase12_test_map.json` row for `NF-AC-029` | `NF-FIX-006-cross-table-graph` | `NFA-C03-001`; `NFA-GP-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-029` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-030` | Table-tab graph defaults to active table scope. | browser + integration | See `tools/phase12_test_map.json` row for `NF-AC-030` | `NF-FIX-006-cross-table-graph` | `NFA-C03-001`; `NFA-GP-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-030` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-031` | Selected tables reject duplicate IDs. | route integration | See `tools/phase12_test_map.json` row for `NF-AC-031` | `NF-FIX-024-query-normalization-cursors` | `NFA-GEN-001`; `NFA-GP-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-031` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-032` | Multiple selected tables compose one filtered graph. | integration | See `tools/phase12_test_map.json` row for `NF-AC-032` | `NF-FIX-006-cross-table-graph` | `NFA-GP-001..003` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-032` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-033` | Canonical endpoint merges across selected tables with provenance. | integration | See `tools/phase12_test_map.json` row for `NF-AC-033` | `NF-FIX-006-cross-table-graph` | `NFA-C02-001`; `NFA-GP-001..003` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-033` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-034` | Default edge aggregation and table provenance are exact. | integration | See `tools/phase12_test_map.json` row for `NF-AC-034` | `NF-FIX-006-cross-table-graph`; `NF-FIX-028-graph-aggregate-bounds` | `NFA-GP-001..003` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-034` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-035` | Time overlap and zero-duration handling are exact. | unit + integration | See `tools/phase12_test_map.json` row for `NF-AC-035` | `NF-FIX-006-cross-table-graph`; `NF-FIX-022-timestamp-rulesets` | `NFA-TZ-001`; `NFA-GP-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-035` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-036` | Vertex selection pivots by stable identity. | browser + integration | See `tools/phase12_test_map.json` row for `NF-AC-036` | `NF-FIX-025-graph-contributors` | `NFA-GP-001..003`; `NFA-C03-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-036` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-037` | Edge selection opens deterministically grouped contributors. | browser + integration | See `tools/phase12_test_map.json` row for `NF-AC-037` | `NF-FIX-025-graph-contributors` | `NFA-GP-001..003`; `NFA-C03-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-037` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-038` | Graph over-limit errors are deterministic with no partial graph. | integration + fault | See `tools/phase12_test_map.json` row for `NF-AC-038` | `NF-FIX-008-large-limits`; `NF-FIX-018-resource-limits`; `NF-FIX-028-graph-aggregate-bounds` | `NFA-GP-003`; `NFA-TH-002` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-038` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-039` | Example refs and truncation fields are exact. | integration | See `tools/phase12_test_map.json` row for `NF-AC-039` | `NF-FIX-006-cross-table-graph`; `NF-FIX-025-graph-contributors` | `NFA-GP-002`; `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-039` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-040` | Adapter input fields and safe metadata are exact. | contract + integration | See `tools/phase12_test_map.json` row for `NF-AC-040` | `NF-FIX-015-graph-adapter-input` | `NFA-GP-001..003` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-040` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-041` | Existing-indicator link binds source without rewriting row. | transactional integration | See `tools/phase12_test_map.json` row for `NF-AC-041` | `NF-FIX-007-indicator-linking` | `NFA-C02-001..002`; `NFA-C01-005` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-041` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-042` | Create-indicator uses Core owner and enforces role. | authorization + integration | See `tools/phase12_test_map.json` row for `NF-AC-042` | `NF-FIX-007-indicator-linking`; `NF-FIX-017-indicator-link-mismatch` | `NFA-C02-001..002`; `NFA-C04-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-042` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-043` | Duplicate link returns existing binding. | transactional integration | See `tools/phase12_test_map.json` row for `NF-AC-043` | `NF-FIX-007-indicator-linking` | `NFA-C02-002`; `NFA-C01-005` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-043` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-044` | Rejected/deleted/stale/unmapped selectors fail. | integration | See `tools/phase12_test_map.json` row for `NF-AC-044` | `NF-FIX-009-soft-delete-stale-graph`; `NF-FIX-017-indicator-link-mismatch`; `NF-FIX-025-graph-contributors` | `NFA-C02-002`; `NFA-GP-003`; `NFA-C04-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-044` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-045` | Deployment admin without membership has no incident access. | authorization integration | See `tools/phase12_test_map.json` row for `NF-AC-045` | `NF-FIX-025-graph-contributors` | `NFA-C04-001`; `NFA-TH-005` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-045` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-046` | Network Flow actions perform no third-party egress. | security integration | See `tools/phase12_test_map.json` row for `NF-AC-046` | n/a: egress-observation scenario | `NFA-C04-001`; `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-046` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-047` | Logs, telemetry, audit, and diagnostics obey raw-value policy. | security + integration | See `tools/phase12_test_map.json` row for `NF-AC-047` | `NF-FIX-016-redaction` | `NFA-C04-003..004`; `NFA-TH-004` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-047` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-048` | Limits are discoverable, lowerable within bounds, and phase-enforced. | contract + integration | See `tools/phase12_test_map.json` row for `NF-AC-048` | `NF-FIX-008-large-limits`; `NF-FIX-018-resource-limits` | `NFA-GEN-001`; `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-048` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-049` | Route errors include required details. | contract conformance | See `tools/phase12_test_map.json` row for `NF-AC-049` | `NF-FIX-010-json-admission`; `NF-FIX-018-resource-limits` | `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-049` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-050` | Large timing remains engineering-only absent Core 05. | structural + harness accounting | See `tools/phase12_test_map.json` row for `NF-AC-050` | `NF-FIX-008-large-limits` | `NFA-C05-001`; `NFA-TH-007` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-050` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-051` | Unmapped raw remains inert provenance. | integration + security | See `tools/phase12_test_map.json` row for `NF-AC-051` | `NF-FIX-011-alias-collision`; `NF-FIX-016-redaction` | `NFA-GEN-001`; `NFA-GP-002` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-051` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-052` | Every fixture has immutable bytes and expected artifacts before adoption. | structural + fixture drift | See `tools/phase12_test_map.json` row for `NF-AC-052` | all `NF-FIX-001` through `NF-FIX-028` full IDs in §8 | `NFA-FIX-001..028`; `NFA-TH-001`; `NFA-VAL-003` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-052` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-053` | Every MAY has omission behavior. | structural lint | See `tools/phase12_test_map.json` row for `NF-AC-053` | n/a: owner document | `NFA-VAL-002`; `NFA-ADOPT-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-053` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-054` | Normative behavior stays in adopted owner documents. | authority review + structural lint | See `tools/phase12_test_map.json` row for `NF-AC-054` | n/a: document set | `NFA-AUTH-001`; `NFA-VAL-002` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-054` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-055` | Internal references resolve. | structural lint | See `tools/phase12_test_map.json` row for `NF-AC-055` | n/a: owner document | `NFA-VAL-002` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-055` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-056` | Edge IDs and null-port aggregation match exact vectors. | unit + integration | See `tools/phase12_test_map.json` row for `NF-AC-056` | `NF-FIX-006-cross-table-graph`; `NF-FIX-028-graph-aggregate-bounds` | `NFA-GP-001..003`; `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-056` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-057` | Time-bucket request members remain unknown. | contract + route integration | See `tools/phase12_test_map.json` row for `NF-AC-057` | `NF-FIX-010-json-admission` | `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-057` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-058` | Only binding observation mode; created observation refs empty. | contract + integration | See `tools/phase12_test_map.json` row for `NF-AC-058` | `NF-FIX-007-indicator-linking` | `NFA-C02-002`; `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-058` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-059` | Graph digests ignore deployment/caller limit changes. | integration | See `tools/phase12_test_map.json` row for `NF-AC-059` | `NF-FIX-006-cross-table-graph`; `NF-FIX-018-resource-limits` | `NFA-GP-001..003`; `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-059` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-060` | Timestamp precision, epochs, and uptime derivation are exact. | unit + fixture conformance | See `tools/phase12_test_map.json` row for `NF-AC-060` | `NF-FIX-012-sys-uptime-timestamps`; `NF-FIX-022-timestamp-rulesets` | `NFA-TZ-001`; `NFA-TH-003` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-060` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-061` | Duplicate rename error and cursor survival are exact. | transactional integration | See `tools/phase12_test_map.json` row for `NF-AC-061` | `NF-FIX-013-filename-display`; `NF-FIX-014-cursor-pagination` | `NFA-C04-002`; `NFA-C01-004`; `NFA-TH-002` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-061` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-062` | Only active/soft-deleted tables and exact limit accounting. | structural + integration | See `tools/phase12_test_map.json` row for `NF-AC-062` | `NF-FIX-027-retention-soft-delete` | `NFA-C04-005`; `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-062` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-063` | All-rejected error has ordered safe diagnostics and no table. | transactional integration | See `tools/phase12_test_map.json` row for `NF-AC-063` | `NF-FIX-004-rejected-rows` | `NFA-C01-004`; `NFA-TH-002`; `NFA-TH-004` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-063` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-064` | Query defaults and graph override bounds are exact. | contract + integration | See `tools/phase12_test_map.json` row for `NF-AC-064` | `NF-FIX-018-resource-limits`; `NF-FIX-024-query-normalization-cursors` | `NFA-GEN-001`; `NFA-GP-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-064` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-065` | Preview slice counts and apply outcomes are independent. | integration | See `tools/phase12_test_map.json` row for `NF-AC-065` | `NF-FIX-021-preview-boundaries` | `NFA-C01-002..005`; `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-065` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-066` | Binding source refs/truncation and duplicate selector handling are exact. | integration | See `tools/phase12_test_map.json` row for `NF-AC-066` | `NF-FIX-007-indicator-linking` | `NFA-C02-002`; `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-066` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-067` | Dedupe uses resolved binding identity tuple. | transactional integration | See `tools/phase12_test_map.json` row for `NF-AC-067` | `NF-FIX-007-indicator-linking` | `NFA-C02-002`; `NFA-C01-005` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-067` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-068` | Exact-value mismatch fails before mutation with safe details. | transactional integration | See `tools/phase12_test_map.json` row for `NF-AC-068` | `NF-FIX-017-indicator-link-mismatch` | `NFA-C02-001..002`; `NFA-TH-002` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-068` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-069` | Adapter uses endpoint/edge IDs and no invalid retention token. | contract + integration | See `tools/phase12_test_map.json` row for `NF-AC-069` | `NF-FIX-015-graph-adapter-input` | `NFA-GP-001..003` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-069` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-070` | Interface fields are bounded text/null and code-point sorted. | unit + integration | See `tools/phase12_test_map.json` row for `NF-AC-070` | `NF-FIX-002-cisco-sna-interface-fields` | `NFA-GEN-001`; `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-070` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-071` | Aggregation and mapping combinability are closed to v1 values. | contract + route integration | See `tools/phase12_test_map.json` row for `NF-AC-071` | `NF-FIX-010-json-admission`; `NF-FIX-011-alias-collision` | `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-071` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-072` | Rename/delete/link/apply idempotency follows exact comparison/replay points. | transactional integration | See `tools/phase12_test_map.json` row for `NF-AC-072` | `NF-FIX-020-atomic-import-commit`; `NF-FIX-026-audit-and-replay` | `NFA-C01-004..005`; `NFA-C02-002`; `NFA-TH-002` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-072` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-073` | Mapping accepts only three variants and rejects extras/sentinels. | contract + integration | See `tools/phase12_test_map.json` row for `NF-AC-073` | `NF-FIX-011-alias-collision` | `NFA-C01-003`; `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-073` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-074` | Alias keys/warnings require explicit complete approval. | parser + browser + integration | See `tools/phase12_test_map.json` row for `NF-AC-074` | `NF-FIX-011-alias-collision` | `NFA-C01-003`; `NFA-C03-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-074` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-075` | Every success data object matches exact closed schema. | contract conformance | See `tools/phase12_test_map.json` row for `NF-AC-075` | `NF-FIX-001-cisco-sna-minimal`; `NF-FIX-023-import-facade-source-change`; `NF-FIX-025-graph-contributors` | `NFA-C01-004`; `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-075` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-076` | All resource limits match defaults, phases, failures, and invalid config. | integration + configuration | See `tools/phase12_test_map.json` row for `NF-AC-076` | `NF-FIX-008-large-limits`; `NF-FIX-018-resource-limits` | `NFA-GEN-001`; `NFA-TH-001`; `NFA-TH-007` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-076` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-077` | Safe/source samples follow exact raw/numeric/null rules. | unit + security | See `tools/phase12_test_map.json` row for `NF-AC-077` | `NF-FIX-016-redaction` | `NFA-C04-003`; `NFA-TH-004` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-077` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-078` | Route errors have exact details and deterministic precedence. | contract + integration | See `tools/phase12_test_map.json` row for `NF-AC-078` | `NF-FIX-004-rejected-rows`; `NF-FIX-018-resource-limits` | `NFA-GEN-001`; `NFA-TH-004` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-078` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-079` | Linking accepts only IP endpoints and validates Core identity. | integration | See `tools/phase12_test_map.json` row for `NF-AC-079` | `NF-FIX-007-indicator-linking`; `NF-FIX-017-indicator-link-mismatch` | `NFA-C02-001..002` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-079` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-080` | Filename/display naming cases match exact rules. | unit + integration | See `tools/phase12_test_map.json` row for `NF-AC-080` | `NF-FIX-013-filename-display` | `NFA-C01-003`; `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-080` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-081` | Final commit faults expose no partial state/audit. | fault + transactional integration | See `tools/phase12_test_map.json` row for `NF-AC-081` | `NF-FIX-020-atomic-import-commit` | `NFA-C01-004`; `NFA-TH-002` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-081` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-082` | Explicit duplicate names fail; omitted names suffix under commit lock. | concurrency + transactional integration | See `tools/phase12_test_map.json` row for `NF-AC-082` | `NF-FIX-013-filename-display`; `NF-FIX-020-atomic-import-commit` | `NFA-C01-004`; `NFA-TH-002`; `NFA-TH-004` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-082` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-083` | Preview stops at 50 complete data records with exact counting. | parser conformance | See `tools/phase12_test_map.json` row for `NF-AC-083` | `NF-FIX-021-preview-boundaries` | `NFA-C01-003`; `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-083` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-084` | Row limit counts logical records and stops at `limit+1`. | parser + integration | See `tools/phase12_test_map.json` row for `NF-AC-084` | `NF-FIX-021-preview-boundaries` | `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-084` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-085` | Cisco profile allows only required plus two interface targets. | parser + contract | See `tools/phase12_test_map.json` row for `NF-AC-085` | `NF-FIX-002-cisco-sna-interface-fields`; `NF-FIX-011-alias-collision` | `NFA-C01-003`; `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-085` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-086` | ASCII-space trim and empty policy are exact. | unit conformance | See `tools/phase12_test_map.json` row for `NF-AC-086` | `NF-FIX-019-canonical-json-unicode` | `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-086` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-087` | Timestamp variants, grammar, ruleset, uptime, and ordinals are closed. | contract + unit conformance | See `tools/phase12_test_map.json` row for `NF-AC-087` | `NF-FIX-012-sys-uptime-timestamps`; `NF-FIX-022-timestamp-rulesets` | `NFA-TZ-001`; `NFA-GEN-001`; `NFA-TH-003` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-087` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-088` | Preview is side-effect-free; apply uses opaque source and fails closed on change. | integration + fault | See `tools/phase12_test_map.json` row for `NF-AC-088` | `NF-FIX-023-import-facade-source-change` | `NFA-C01-003..005`; `NFA-TH-002` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-088` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-089` | Descriptors/dispositions/mappings and provenance are exact. | contract + integration | See `tools/phase12_test_map.json` row for `NF-AC-089` | `NF-FIX-003-duplicate-headers`; `NF-FIX-011-alias-collision`; `NF-FIX-023-import-facade-source-change` | `NFA-C01-002..005`; `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-089` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-090` | Public rows include nullable fields, unmapped values, and observation ref. | contract + integration | See `tools/phase12_test_map.json` row for `NF-AC-090` | `NF-FIX-001-cisco-sna-minimal`; `NF-FIX-011-alias-collision` | `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-090` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-091` | Parallel diagnostic discovery is byte-identical and ordered. | concurrency + integration | See `tools/phase12_test_map.json` row for `NF-AC-091` | `NF-FIX-004-rejected-rows` | `NFA-TH-004` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-091` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-092` | Table scopes reject invalid variants without resource disclosure. | authorization + contract integration | See `tools/phase12_test_map.json` row for `NF-AC-092` | `NF-FIX-024-query-normalization-cursors` | `NFA-C04-001`; `NFA-GEN-001`; `NFA-TH-005` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-092` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-093` | Filter normalization canonicalizes and rejects canonical duplicates. | unit + integration | See `tools/phase12_test_map.json` row for `NF-AC-093` | `NF-FIX-019-canonical-json-unicode`; `NF-FIX-024-query-normalization-cursors` | `NFA-C02-001`; `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-093` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-094` | Initial/continuation variants and token byte/expiry bounds are exact. | security + integration | See `tools/phase12_test_map.json` row for `NF-AC-094` | `NF-FIX-014-cursor-pagination`; `NF-FIX-024-query-normalization-cursors` | `NFA-C04-002`; `NFA-TH-003`; `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-094` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-095` | Three cursor families use independent full keysets without gaps/duplicates. | integration | See `tools/phase12_test_map.json` row for `NF-AC-095` | `NF-FIX-014-cursor-pagination`; `NF-FIX-024-query-normalization-cursors`; `NF-FIX-025-graph-contributors` | `NFA-C04-002`; `NFA-GP-003`; `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-095` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-096` | Arbitrary-precision aggregation and fixed failure order have no partial output. | unit + integration | See `tools/phase12_test_map.json` row for `NF-AC-096` | `NF-FIX-028-graph-aggregate-bounds` | `NFA-GP-003`; `NFA-TH-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-096` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-097` | Projection metadata and outcome mapping are exact and safe. | contract + integration | See `tools/phase12_test_map.json` row for `NF-AC-097` | `NF-FIX-015-graph-adapter-input` | `NFA-GP-001..003` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-097` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-098` | Graph success schema is exact and closed. | contract + integration | See `tools/phase12_test_map.json` row for `NF-AC-098` | `NF-FIX-025-graph-contributors` | `NFA-GP-001..003`; `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-098` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-099` | Contributors recompute composition/auth and paginate without fallback. | authorization + integration | See `tools/phase12_test_map.json` row for `NF-AC-099` | `NF-FIX-025-graph-contributors` | `NFA-GP-001..003`; `NFA-C03-002`; `NFA-TH-005` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-099` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-100` | Indicator variants and exact confirmation are closed; create input is constrained. | contract + integration | See `tools/phase12_test_map.json` row for `NF-AC-100` | `NF-FIX-017-indicator-link-mismatch` | `NFA-C02-001..002`; `NFA-GEN-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-100` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-101` | Indicator create/dedupe plus binding is atomic with exact statuses. | transactional integration | See `tools/phase12_test_map.json` row for `NF-AC-101` | `NF-FIX-007-indicator-linking`; `NF-FIX-026-audit-and-replay` | `NFA-C02-002`; `NFA-C01-004`; `NFA-TH-002` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-101` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-102` | Safe digests carry key IDs and compare only within a key ID. | security + unit/integration | See `tools/phase12_test_map.json` row for `NF-AC-102` | `NF-FIX-016-redaction`; `NF-FIX-026-audit-and-replay` | `NFA-C04-003`; `NFA-TH-004` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-102` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-103` | Audit occurrences/replay/truncation counts are exact. | transactional + audit integration | See `tools/phase12_test_map.json` row for `NF-AC-103` | `NF-FIX-026-audit-and-replay` | `NFA-C04-004`; `NFA-C01-005`; `NFA-TH-006` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-103` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-104` | Soft delete and incident closure retain but make Network Flow data non-queryable, and v1 exposes no incident-purge claim. | retention + integration | See `tools/phase12_test_map.json` row for `NF-AC-104` | `NF-FIX-009-soft-delete-stale-graph`; `NF-FIX-027-retention-soft-delete` | `NFA-C00-002`; `NFA-C04-005`; `NFA-TH-005`; `NFA-TH-006` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-104` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-105` | Every route status/schema/error/reason/detail/retry is exact. | generated-contract + integration | See `tools/phase12_test_map.json` row for `NF-AC-105` | all applicable route fixtures in §8 | `NFA-GEN-001`; `NFA-C01-004`; `NFA-C04-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-105` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-106` | All locators, blockers, and immutable fixtures close before adoption. | structural + adoption review | See `tools/phase12_test_map.json` row for `NF-AC-106` | all `NF-FIX-001` through `NF-FIX-028` full IDs in §8 | `NFA-LOC-001`; `NFA-FIX-001..028`; `NFA-ADOPT-001` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-106` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
| `NF-AC-107` | Pre-commit cancellation leaves nothing; post-commit recovery publishes once. | worker fault + transactional integration | See `tools/phase12_test_map.json` row for `NF-AC-107` | `NF-FIX-020-atomic-import-commit`; `NF-FIX-023-import-facade-source-change` | `NFA-C01-004..005`; `NFA-TH-004`; `NFA-TH-007` | Executable selector owned by `tools/phase12_test_map.json` for `NF-AC-107` | `make phase-slice PHASE=phase12` `.cartulary/test-results/20260710T154140Z-p73390`; retained service-backed `.cartulary/test-results/20260710T151210Z-p71906` where applicable | `DONE` | Closed by executable selector promotion, retained validation, final adoption artifacts `f4409d98`/`e83b3719`, and §15.42 evidence. |
...
- `2026-07-10T16:06:55-04:00` — completed final `NFA-HANDOFF-001` closeout
  after adoption checkpoint `f677559a`. An initial final `make check` run at
  `.cartulary/test-results/20260710T160219Z-p3484` correctly failed because
  the tracker duplicated Phase 12 authoritative selector IDs that belong to
  `tools/phase12_test_map.json`; the tracker handoff matrix now references the
  generated map by `NF-AC-*` row only. `make phase-ledger-drift` passed at
  `.cartulary/test-results/20260710T160404Z-p36641`, full `make check` passed
  at `.cartulary/test-results/20260710T160410Z-p37044`, and
  `make agent-finalize RESULTS_DIR=.cartulary/test-results/20260710T160410Z-p37044`
  passed at `.cartulary/test-results/20260710T160629Z-p38728` while refreshing
  six Make-owned scheduler/duration artifacts.

### 14.9 Current session handoff

| Field | Value |
| --- | --- |
| Date/time | `2026-07-10T16:06:55-04:00` |
| Branch/commit | `main`; latest committed checkpoint `f677559a` after adoption artifacts `f4409d98` and `e83b3719`; final handoff artifact is this closeout commit |
| Dirty-tree state | Final handoff tracker edit plus Make-owned finalizer refresh files before the closeout commit |
| Current workflow/task | Commit final `NFA-HANDOFF-001` closeout |
| Completed tasks | All owner, generated, implementation, fixture, workspace, Phase 12 selector, retained conformance, security/drift, full check, finalization, Core 00/NLSpec adoption, Phase 12 aggregate claim-accounting, and final handoff workstreams |
| Tracker file changed | `docs/handoffs/network-flow-activity-adoption-handoff-tracker.md` |
| Other changed files | `tools/browser_e2e_duration_baselines.json`; `tools/execution_topology_render_index.json`; `tools/go_test_duration_baselines.json`; `tools/harness_smoke_duration_baselines.json`; `tools/scheduler_manifest.json`; `tools/service_backed_make_target_duration_baselines.json` from `make agent-finalize` |
| Commands run | Final closeout commands in §15.43, including failed-then-fixed `make check`, `make phase-ledger-drift`, successful retained `make check`, `make agent-finalize RESULTS_DIR=.cartulary/test-results/20260710T160410Z-p37044`, and final tracker checks |
| Passing validation | Final validation is recorded in §15.43; adoption validation remains recorded in §15.42; retained conformance and security/drift validation remain recorded in §§15.40-15.41 |
| Failing validation | Initial final `make check` failed at `.cartulary/test-results/20260710T160219Z-p3484` because the tracker duplicated generated Phase 12 selector IDs; tracker wording was corrected and `make phase-ledger-drift` plus full `make check` passed afterward |
...
| Blockers | none |
| Next recommended task/workflow | No adoption work remains; future work should start from a new tracker or issue, not by reopening this handoff |
| Safe restart command | `git status --short && rg -n "NFA-HANDOFF-001\|15\.43\|adopted/current\|network_flow_activity" docs/handoffs/network-flow-activity-adoption-handoff-tracker.md docs/network-flow-activity-nlspec.md docs/spec/00_document_set_status_and_precedence.md tools/phase12_test_map.json` |
...
| Harness deterministic-randomness artifact | Pass; artifact commit `84eb7fb5d4a8ba0ae0476ce5562126f2355f45f0` added `docs/testing-harness-nlspec.md` owner text, `tools/schemas/cartulary.test.network_flow_randomness_control.v1.schema.json`, schema contract tests, the current successor `internal/platform/harnessruntime/network_flow_randomness.go`, and route/reset integration tests |
...
| Harness auth-transition artifact | Pass; artifact commit `43b0fe36e2c35022c13a4b33e9d226b6303ae379` added `docs/testing-harness-nlspec.md` owner text, `tools/schemas/cartulary.test.network_flow_auth_transition_control.v1.schema.json`, schema contract tests, the current successor `internal/platform/harnessruntime/network_flow_auth_transition.go`, and route/reset integration tests |
...
| Test result | Pass; new selectors live in `internal/modules/networkflow/phase12_network_flow_unit_test.go`, `internal/modules/networkflow/phase12_network_flow_contract_test.go`, and `apps/web/e2e/phase12.network-flow.spec.ts`; existing store selectors remain authoritative where already mapped |
...
### 15.43 `NFA-HANDOFF-001` final handoff closeout results

| Check | Result |
| --- | --- |
| Start checkpoint | Pass; final handoff started from clean committed checkpoint `f677559a` after adoption/status checkpointing completed |
| Ownership correction | Pass; initial final `make check` failed at `.cartulary/test-results/20260710T160219Z-p3484` because this tracker duplicated generated Phase 12 authoritative selector IDs; §9 now references `tools/phase12_test_map.json` by `NF-AC-*` row and does not embed generated selector IDs |
| Targeted drift rerun | Pass; `make phase-ledger-drift` passed at `.cartulary/test-results/20260710T160404Z-p36641` after the tracker matrix correction |
| Full retained validation | Pass; `make check` passed at `.cartulary/test-results/20260710T160410Z-p37044` with 1,058 tests, zero failures, zero missing rows, and all 338 scheduler work units complete |
| Finalization | Pass; `make agent-finalize RESULTS_DIR=.cartulary/test-results/20260710T160410Z-p37044` passed at `.cartulary/test-results/20260710T160629Z-p38728`; retained-run checks passed and six Make-owned scheduler/duration artifacts were refreshed |
| Supplemental generated validation | Pass; `make generated-artifact-policy-check` `.cartulary/test-results/20260710T160952Z-p43548`, `make json-shape-check` `.cartulary/test-results/20260710T160952Z-p43551`, and `make phase-schedule-drift` `.cartulary/test-results/20260710T160952Z-p43615` passed after the finalizer refresh |
| Tracker transition | Pass; `NFA-HANDOFF-001` is `DONE`; `NFA-C00-002`, `NFA-ADOPT-001`, `NFA-VAL-002`, `NFA-VAL-003`, all gates, all blockers, all fixtures, all generated rows, and all 107 `NF-AC-*` rows are complete |
| Final scope | Pass; no product behavior, public API, owner status, fixture bytes, selector map, generated contract root, or schema semantics changed during this closeout; only the tracker matrix ownership wording and Make-owned finalizer refresh artifacts changed |
| Final tracker validation | Pass; `make lint-markdown`, `git diff --check`, table-column validation, active-open-status sweep, count/contiguity check, and forbidden Phase 12 selector-ID scan passed after this closeout edit |
| Handoff state | Pass; no adoption blocker, unresolved gate, fixture TODO, acceptance TODO, or final handoff task remains open |
...
- [x] Final handoff closeout and retained-run finalization are recorded.

## 17. Tracker-level binary acceptance criteria

| ID | Criterion | Current result |
| --- | --- | --- |
| `NF-HT-AC-001` | The tracker records branch, commit, dirty-tree state, sources, and search limits. | `PASS: final handoff (§15.43)` |
| `NF-HT-AC-002` | Every Table 1-B dependency maps to owner sections, tracker tasks, and a closure condition. | `PASS: final handoff (§15.43)` |
| `NF-HT-AC-003` | Every `NF-GATE-*` and `NF-BLOCK-*` ID appears exactly once in the crosswalk and maps to actionable tasks. | `PASS: final handoff (§15.43)` |
| `NF-HT-AC-004` | Every `NF-FIX-*` ID has its own byte/hash/manifest/transcript/evidence row. | `PASS: final handoff (§15.43)` |
| `NF-HT-AC-005` | Every `NF-AC-*` ID has one executable-evidence row owned through the generated Phase 12 map. | `PASS: final handoff (§15.43)` |
| `NF-HT-AC-006` | No dependency, fixture, acceptance criterion, or status transition is `DONE` without named evidence. | `PASS: final handoff (§15.43)` |
| `NF-HT-AC-007` | Owner amendments precede derived contracts, generated outputs, implementation, and frozen transcripts. | `PASS: final handoff (§15.43)` |
| `NF-HT-AC-008` | Generated files are identified and no hand edit is planned. | `PASS: final handoff (§15.43)` |
| `NF-HT-AC-009` | Security fixtures use isolated fixture key material and reveal no production secret. | `PASS: final handoff (§15.43)` |
| `NF-HT-AC-010` | Time, randomness, locale, Unicode, timezone, ordering, and line endings freeze wherever they affect bytes/transcripts. | `PASS: final handoff (§15.43)` |
| `NF-HT-AC-011` | Every checkpoint names prerequisites, validation, expected artifacts, and rollback/stop point. | `PASS: final handoff (§15.43)` |
| `NF-HT-AC-012` | Existing repository drift and owner contradictions remain visible and resolved or explicitly deferred. | `PASS: final handoff (§15.43)` |
| `NF-HT-AC-013` | Final transition cannot complete with any gate, blocker, fixture, locator, generated check, or AC open. | `PASS: final handoff (§15.43)` |
| `NF-HT-AC-014` | The handoff permits resumption without repeating repository discovery. | `PASS: final handoff (§15.43)` |
| `NF-HT-AC-015` | Only this tracker and explicitly recorded Make-owned finalizer refresh files are newly changed; unrelated dirty state is preserved and recorded. | `PASS: final handoff (§15.43)` |
