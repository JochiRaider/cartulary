...
- `internal/platform/config/backup_config_test.go` runs through `backend-unit` with `TestBackupStorageRootBindingConfig` and is forbidden from claiming `U-10-*` identifiers.
