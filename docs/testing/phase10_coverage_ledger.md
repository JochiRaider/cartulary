...
- Phase 10 is active with Sprint 9 remediation evidence for durable retained-backup classification and encrypted backup storage. Canonical operator recovery evidence is pending under blocked row `E-10-01`.
...
- Sprint 2 gives `U-10-04` and `E-10-03` direct public route-family absence evidence; canonical operator authorization remains blocked pending replacement of `E-10-01`.
...
- Sprint 9 remediation gives `U-10-01`, `U-10-05`, and `I-10-01` direct evidence for durable artifact-backed classification and encrypted artifact envelopes. Legacy `operator restore-verify due` deployment-admin evidence is negative-only until canonical evidence replaces it.
...
- `backend-process` selects process public-route absence evidence for `E-10-03`, direct restore readiness evidence for `U-10-02`, `U-10-03`, `I-10-02`, and `I-10-03`, and direct effective-config startup rejection evidence for `E-10-04`. `E-10-01` is blocked until canonical operator recovery evidence exists.
...
| Row | Claim status | Evidence | Execution | Claim | Out of scope |
| --- | --- | --- | --- | --- | --- |
| `E-10-01` | `blocked` | `cmd/operator/operator_phase10_test.go::TestPhase10_E_10_01_DeploymentLocalOperatorInspectLatestBackupMetadata`, `TestPhase10_E_10_01_DeploymentLocalOperatorCaptureBackupSet`, `TestPhase10_E_10_01_DeploymentLocalOperatorRestoreLatestBackup`, `TestPhase10_E_10_01_DeploymentLocalOperatorRestoreVerifyDueRunner`, `TestPhase10_E_10_01_ObjectStoreMigrationRunEmitsPassEvidence`, `TestPhase10_E_10_01_ObjectStoreMigrationRunEmitsMismatchEvidence` | `backend_process` | Blocked pending canonical Core 01/Core 04 operator recovery evidence for the five logical commands, local-operator authority, Core result/progress schemas, closed exit mapping, safe output, and recovery-operation preflight/journal/audit behavior. | The listed legacy `deployment_admin`-gated operator tests are negative-only implementation-support fixtures and cannot close AC-402, AC-427, or AC-428. Object-store migration tooling remains support-only and is not recovery conformance. |
