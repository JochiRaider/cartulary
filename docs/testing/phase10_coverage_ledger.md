...
- `backend-process` selects canonical operator recovery evidence for `E-10-01`, process public-route absence evidence for `E-10-03`, direct restore readiness evidence for `U-10-02`, `U-10-03`, `I-10-02`, and `I-10-03`, and direct effective-config startup rejection evidence for `E-10-04`.
...
- `cmd/operator/operator_phase10_test.go` runs through `backend-process` with `TestSupportPhaseF_SeaweedFSMigrationPreservation` and is forbidden from claiming `E-10-*` identifiers.
