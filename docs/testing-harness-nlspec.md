...
| `browser_stage_session_start` | `service_target`, `browser_stage` | none | `target`, `shard`, `group_id` | Starts the browser stage for an existing service session and retains declared browser/process claims until stage completion. |
