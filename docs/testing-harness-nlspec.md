...
Frontend readiness mechanics introduced by `browser-e2e-a11y`, `tools/frontend_phase_registry.json`, `tools/frontend_phase_maps/*.json`, `docs/testing/frontend_phase_coverage_ledgers/*.md`, and `cartulary.frontend_accessibility_summary.v1` are harness and implementation-readiness mechanics only. They MUST NOT define Core product behavior, MUST NOT promote visual or accessibility evidence into product-conformance evidence, and MUST NOT activate Core 05 claim-publication review unless a claim-bearing publication predicate is active.
Verified by: TH-HARNESS-AC-013, TH-HARNESS-AC-016, TH-HARNESS-AC-022
...
**TH-HARNESS-REQ-050**
The public command registry MUST be closed over public targets in `tools/task_surface_manifest.json` with `target_class="public"`. The implementation MUST provide exactly the public targets listed in the target registry below unless the manifest and this NLSpec are revised together.
...
| `tools/task_surface_manifest.json` public target_class |                                         yes | Source input for public target registry completeness.                                  |
...
| static analysis and security | `static_analysis_security` | Toolchain and source roots | Rule variables from Make; `LINT_SHELL_STRICT=1` makes shell lint blocking. | `summary_with_artifacts` | Scheduled inside `check` where declared. | None | Tool summary and logs. | Findings are gate failures unless target definition makes them warning-only. |
| builds | `builds` | Build inputs and toolchain | Output paths from Make variables. | `summary_with_artifacts` | Scheduled as readiness work where declared. | None | Tool summary and build logs. | Build failures are gate failures. |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `help` | `cartulary.harness.command.help.v1` | `help_discovery` | `helper_only` | `human_summary` | none | `diagnostic_synthesis` (Section 4) | `public_active` |   |
| `help-all` | `cartulary.harness.command.help_all.v1` | `help_discovery` | `helper_only` | `human_summary` | none | `diagnostic_synthesis` (Section 4) | `public_active` |   |
| `doctor` | `cartulary.harness.command.doctor.v1` | `bootstrap_toolchain` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `bootstrap` | `cartulary.harness.command.bootstrap.v1` | `bootstrap_toolchain` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `bootstrap-node-runtime` | `cartulary.harness.command.bootstrap_node_runtime.v1` | `bootstrap_toolchain` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `frontend-toolchain` | `cartulary.harness.command.frontend_toolchain.v1` | `bootstrap_toolchain` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `frontend-install` | `cartulary.harness.command.frontend_install.v1` | `bootstrap_toolchain` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `playwright-install` | `cartulary.harness.command.playwright_install.v1` | `bootstrap_toolchain` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `db-up` | `cartulary.harness.command.db_up.v1` | `local_services_dev` | `helper_only` | `service_summary` | `cartulary.tool_run_summary.v3` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `db-reset` | `cartulary.harness.command.db_reset.v1` | `local_services_dev` | `helper_only` | `service_summary` | `cartulary.tool_run_summary.v3` | `destructive_safety` (Section 13), `failure_normalization` (Section 9) | `public_active` |   |
| `services-up` | `cartulary.harness.command.services_up.v1` | `local_services_dev` | `helper_only` | `service_summary` | `cartulary.tool_run_summary.v3` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `minio-init` | `cartulary.harness.command.minio_init.v1` | `local_services_dev` | `helper_only` | `service_summary` | `cartulary.tool_run_summary.v3` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `dev` | `cartulary.harness.command.dev.v1` | `local_services_dev` | `helper_only` | `interactive_raw` | none | `service_lifecycle` (Section 11) | `public_active` |   |
| `generate` | `cartulary.harness.command.generate.v1` | `generated_drift` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `generate-drift` | `cartulary.harness.command.generate_drift.v1` | `generated_drift` | `check` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `generated-artifact-policy-check` | `cartulary.harness.command.generated_artifact_policy_check.v1` | `generated_drift` | `check` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `json-shape-check` | `cartulary.harness.command.json_shape_check.v1` | `generated_drift` | `check` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `toolchain-drift` | `cartulary.harness.command.toolchain_drift.v1` | `generated_drift` | `check` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `migration-drift` | `cartulary.harness.command.migration_drift.v1` | `generated_drift` | `check` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `phase-ledgers` | `cartulary.harness.command.phase_ledgers.v1` | `generated_drift` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `phase-ledger-drift` | `cartulary.harness.command.phase_ledger_drift.v1` | `generated_drift` | `check` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `phase-schedules` | `cartulary.harness.command.phase_schedules.v1` | `generated_drift` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `phase-schedule-drift` | `cartulary.harness.command.phase_schedule_drift.v1` | `generated_drift` | `check` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `agent-finalize` | `cartulary.harness.command.agent_finalize.v1` | `generated_drift` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `benchmark-claim-check` | `cartulary.harness.command.benchmark_claim_check.v1` | `generated_drift` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `task-surface-report` | `cartulary.harness.command.task_surface_report.v1` | `help_discovery` | `helper_only` | `human_summary` | none | `diagnostic_synthesis` (Section 4) | `public_active` |   |
| `task-guide` | `cartulary.harness.command.task_guide.v1` | `help_discovery` | `helper_only` | `human_summary` | none | `diagnostic_synthesis` (Section 4) | `public_active` |   |
| `phase-slice` | `cartulary.harness.command.phase_slice.v1` | `phase_service_slices` | `helper_only` | `scheduler_summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `scheduler_orchestration` (Section 10), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `service-backed-slice` | `cartulary.harness.command.service_backed_slice.v1` | `phase_service_slices` | `helper_only` | `scheduler_summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `scheduler_orchestration` (Section 10), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `backend-unit` | `cartulary.harness.command.backend_unit.v1` | `backend_frontend_leaf_tests` | `test`, `check`, `ci` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `backend-store` | `cartulary.harness.command.backend_store.v1` | `backend_frontend_leaf_tests` | `test`, `check`, `ci` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `backend-integration` | `cartulary.harness.command.backend_integration.v1` | `backend_frontend_leaf_tests` | `test`, `check`, `ci` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `backend-process` | `cartulary.harness.command.backend_process.v1` | `backend_frontend_leaf_tests` | `test`, `check`, `ci` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `target-plan` | `cartulary.harness.command.target_plan.v1` | `help_discovery` | `helper_only` | `human_summary` | none | `diagnostic_synthesis` (Section 4) | `public_active` |   |
| `target-plan-json` | `cartulary.harness.command.target_plan_json.v1` | `help_discovery` | `helper_only` | `machine_stdout` | none | `diagnostic_synthesis` (Section 4) | `public_active` |   |
| `fixture-report` | `cartulary.harness.command.fixture_report.v1` | `help_discovery` | `helper_only` | `human_summary` | none | `diagnostic_synthesis` (Section 4) | `public_active` |   |
| `explain-run` | `cartulary.harness.command.explain_run.v1` | `help_discovery` | `helper_only` | `human_summary` | none | `diagnostic_synthesis` (Section 4) | `public_active` |   |
| `explain-phase` | `cartulary.harness.command.explain_phase.v1` | `help_discovery` | `helper_only` | `human_summary` | none | `diagnostic_synthesis` (Section 4) | `public_active` |   |
| `explain-target` | `cartulary.harness.command.explain_target.v1` | `help_discovery` | `helper_only` | `human_summary` | none | `diagnostic_synthesis` (Section 4) | `public_active` |   |
| `go-test-duration-baselines` | `cartulary.harness.command.go_test_duration_baselines.v1` | `generated_drift` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `go-test-duration-baseline-coverage` | `cartulary.harness.command.go_test_duration_baseline_coverage.v1` | `generated_drift` | `check` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `go-test-duration-baseline-drift` | `cartulary.harness.command.go_test_duration_baseline_drift.v1` | `generated_drift` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `browser-e2e-duration-baselines` | `cartulary.harness.command.browser_e2e_duration_baselines.v1` | `generated_drift` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `browser-e2e-duration-baseline-drift` | `cartulary.harness.command.browser_e2e_duration_baseline_drift.v1` | `generated_drift` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `service-backed-make-target-duration-baselines` | `cartulary.harness.command.service_backed_make_target_duration_baselines.v1` | `generated_drift` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `service-backed-make-target-duration-baseline-drift` | `cartulary.harness.command.service_backed_make_target_duration_baseline_drift.v1` | `generated_drift` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `harness-smoke-duration-baselines` | `cartulary.harness.command.harness_smoke_duration_baselines.v1` | `generated_drift` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `harness-smoke-duration-baseline-drift` | `cartulary.harness.command.harness_smoke_duration_baseline_drift.v1` | `generated_drift` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `scheduler-event-order-drift` | `cartulary.harness.command.scheduler_event_order_drift.v1` | `generated_drift` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `scheduler-summary-timing-drift` | `cartulary.harness.command.scheduler_summary_timing_drift.v1` | `generated_drift` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `frontend-typecheck` | `cartulary.harness.command.frontend_typecheck.v1` | `backend_frontend_leaf_tests` | `test`, `check`, `ci` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `frontend-unit` | `cartulary.harness.command.frontend_unit.v1` | `backend_frontend_leaf_tests` | `test`, `check`, `ci` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `frontend-import-boundary-check` | `cartulary.harness.command.frontend_import_boundary_check.v1` | `backend_frontend_leaf_tests` | `check` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `lint-biome` | `cartulary.harness.command.lint_biome.v1` | `static_analysis_security` | `check` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `lint-scripts` | `cartulary.harness.command.lint_scripts.v1` | `static_analysis_security` | `check` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `lint-shell` | `cartulary.harness.command.lint_shell.v1` | `static_analysis_security` | `check` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `format` | `cartulary.harness.command.format.v1` | `formatting` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `browser-e2e` | `cartulary.harness.command.browser_e2e.v1` | `browser_e2e` | `test`, `check`, `ci` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `browser-e2e-webserver-backed` | `cartulary.harness.command.browser_e2e_webserver_backed.v1` | `browser_e2e` | `test`, `check`, `ci` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `browser-e2e-stateful` | `cartulary.harness.command.browser_e2e_stateful.v1` | `browser_e2e` | `test`, `check`, `ci` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `browser-e2e-measurement` | `cartulary.harness.command.browser_e2e_measurement.v1` | `browser_e2e` | `test`, `ci` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `browser-e2e-a11y` | `cartulary.harness.command.browser_e2e_a11y.v1` | `browser_e2e` | `test`, `check`, `ci` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` | Emits `cartulary.frontend_accessibility_summary.v1` as retained readiness evidence. |
| `browser-e2e-visual` | `cartulary.harness.command.browser_e2e_visual.v1` | `browser_e2e` | `test`, `check`, `ci` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `test-fast` | `cartulary.harness.command.test_fast.v1` | `aggregates_gates` | `test`, `check`, `ci` | `aggregate_summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `test` | `cartulary.harness.command.test.v1` | `aggregates_gates` | `test`, `check`, `ci` | `aggregate_summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `lint` | `cartulary.harness.command.lint.v1` | `aggregates_gates` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `go-vulncheck` | `cartulary.harness.command.go_vulncheck.v1` | `static_analysis_security` | `check` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `security_boundary` (Section 15), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `go-gosec-targeted` | `cartulary.harness.command.go_gosec_targeted.v1` | `static_analysis_security` | `check` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `security_boundary` (Section 15), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `go-gosec-audit` | `cartulary.harness.command.go_gosec_audit.v1` | `static_analysis_security` | `check` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `security_boundary` (Section 15), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `check` | `cartulary.harness.command.check.v1` | `aggregates_gates` | `check` | `scheduler_summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `scheduler_orchestration` (Section 10), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `ci` | `cartulary.harness.command.ci.v1` | `aggregates_gates` | `ci` | `aggregate_summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `release-check` | `cartulary.harness.command.release_check.v1` | `aggregates_gates` | `release-check` | `aggregate_summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `build` | `cartulary.harness.command.build.v1` | `builds` | `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `build-server` | `cartulary.harness.command.build_server.v1` | `builds` | `check`, `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `build-migrate` | `cartulary.harness.command.build_migrate.v1` | `builds` | `check`, `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
| `build-operator` | `cartulary.harness.command.build_operator.v1` | `builds` | `check`, `helper_only` | `summary_with_artifacts` | `cartulary.tool_run_summary.v3` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | `public_active` |   |
...
| Postgres fixture policy                                                                         | service suite           | `template_clone`, `transaction`, `package_reset`, `group_clone`, `migration_scratch`; table lists use comma-separated SQL identifiers | default policy `template_clone`                                                           | Make variable, env, manifest, default           | omitted                                                 | lower-case exact token; table identifiers sorted for summaries                                                | unknown policy or bad identifier: `configuration_error`, exit `2`                  | policy, fixture class, schema hash, table count    |
...
| Browser owned-stack env                                                                         | browser                 | runtime roots, origins, backend/frontend port overrides                                                               | dynamic ports; public origin `http://127.0.0.1:4173` when not overridden                  | Make variable, env, manifest, default           | invalid for required values                             | origins lower-case scheme/host where applicable; ports decimal; backend readiness must prove owned process identity through the token-protected test runtime identity route | config or port collision: `resource_conflict`; invalid config: `configuration_error` | origins, ports, runtime root, ownership proof      |
...
| `service_summary`                  | `db-up`, `db-reset`, `services-up`, `minio-init`                                                  |                 yes | One `cartulary.tool_run_summary.v3` JSON object plus LF | Empty after wrapper starts                                                            | Tool-run summary and service diagnostics where applicable | Same schema with service failure fields                                |
...
| ---------------------------------------------------- | ----------------------------------------------- | --------------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| Tool-run summary                                     | Centralized wrappers                            | `<target>/tool-run-summary.json` or target-specific summary dir | `cartulary.tool_run_summary.v3`                               | Required non-null timestamps, target, exit code, output mode, artifact refs, failures | Retained; removed by cleanup only under default result root. |
...
| Agent finalizer summary                              | Agent finalizer                                 | `agent-finalize/finalize-summary.json`                          | `cartulary.agent_finalize_summary.v2`                         | Ordered actions, private substeps, skipped work, updated files, `RESULTS_DIR`, child artifact refs | Retained.                                                    |
...
| Browser stack metadata                               | Browser stack                                   | browser target support dir                                      | `cartulary.web_e2e_stack.v2`                                  | Origins, ports, runtime root, log paths, process group IDs, readiness timestamps, backend identity proof, frontend ownership proof, and selected fixture identity where known | Retained for browser target.                                 |
...
| Frontend accessibility summary                       | Browser accessibility target                    | `browser-e2e-a11y/accessibility/frontend-accessibility-summary.json` | `cartulary.frontend_accessibility_summary.v1`                  | `phase_rows[]`, `scenarios[]`, `keyboard_matrix[]`, `state_communication_checks[]`, `contrast_checks[]`, `violations[]`, and `artifact_refs[]` ordered by producer contract | Retained for browser target.                                 |
...
| --- | ---: | ---: | --- | --- |
| `structure_ledger_refresh` | no | yes | Refresh phase-ledger and phase-schedule generated artifacts, then verify no unsupported drift remains. | Finalizer summary, child summaries, updated-file list. |
| `schema_shape_validation` | no | no | Validate harness-owned JSON shape and schema attachments needed by the finalizer path. | Finalizer summary and child summaries. |
| `duration_baseline_refresh` | yes | yes | Refresh only advisory harness duration-baseline artifacts from a successful, uncontaminated retained run. | Finalizer summary, child summaries, updated-file list. |
| `duration_baseline_coverage` | no | no | Verify that required advisory duration-baseline entries exist or are explicitly defaulted. | Finalizer summary and child summaries. |
| `duration_baseline_drift_validation` | yes | no | Validate advisory duration-baseline freshness against the retained run without promoting the baselines to benchmark claims or product performance conformance evidence. | Finalizer summary and child summaries. |
| `scheduler_drift_validation` | yes | no | Validate scheduler event ordering and warm-check timing health against the retained run. | Finalizer summary and child summaries. |
...
`agent-finalize` MUST retain `agent-finalize/finalize-summary.json` with schema ID `cartulary.agent_finalize_summary.v2`. The summary MUST include selected actions, private substeps, skipped work, updated files, `RESULTS_DIR`, failure records, and child artifact references. Human summary output MUST include one compact `[FINALIZE]` line before the ordinary `[RESULT]` line. Machine output MUST remain exactly one `cartulary.tool_run_summary.v3` JSON object; callers MUST use the `finalize_summary` artifact reference to read command-specific finalizer details.
...
**TH-HARNESS-REQ-399**
Postgres fixture selection MUST be intent-based so future phase growth does not turn fixture setup into hidden critical-path cost. Service-backed Go manifests are the owner for target fixture policy; helper defaults are only a local fallback for direct invocation.
...
| `reusable_database` | `package_reset`, `group_clone`        | Route/runtime tests proven safe to reuse a package or group DB with a closed reset surface.  | `package_reset` MUST declare `dirty_tables` except reset-conformance tests. |
| `isolated_clone`    | `template_clone`                      | Tests needing DB identity, schema mutation, process/runtime isolation, or unsafe reset state. | MUST declare why clone isolation is required in the phase manifest.         |
...
Broad mutable-table package reset is harness conformance behavior, not a default test strategy. New reusable reset rows MUST declare a targeted table set that is closed over relevant foreign-key dependencies. If a test cannot express a small targeted reset safely, it MUST remain an `isolated_clone` until the test is refactored.
...
The frontend is ready only when the wrapper-started frontend process group is still alive, the selected frontend port is owned by a process in that process group when listener process metadata is available, the frontend HTTP probe succeeds, and the process group remains alive after the probe. A stale or unrelated listener MUST NOT satisfy browser readiness.
...
**TH-HARNESS-REQ-450**
Test-only runtime control routes are harness routes. They include `POST /api/v1/test/runtime/reset`, `GET /api/v1/test/runtime/identity`, `POST /api/v1/test/clock/set`, and any future `/api/v1/test/*` or `/ws/v1/test/*` route that observes or mutates harness runtime state. They MUST be unavailable unless every enablement predicate below is satisfied. They MUST NOT be documented as production API behavior.
...
| Production/default runtime     | Runtime control routes are not registered.                                           |

### 12.2 Authorization

| Request condition                                     | Behavior                                                     |
| ----------------------------------------------------- | ------------------------------------------------------------ |
| Runtime control route not enabled                     | Return ordinary not-found behavior.                          |
| Runtime control route enabled, missing token header   | `403`, `error.code=test_route_forbidden`.                    |
| Runtime control route enabled, wrong token header     | `403`, `error.code=test_route_forbidden`.                    |
| Runtime control route enabled, correct token header   | Evaluate request after host/origin boundary checks.          |
| Cookie-authenticated request without token            | Forbidden; session auth does not authorize runtime controls. |
| Bearer/session/bootstrap-token request without token  | Forbidden; product auth does not authorize runtime controls. |

CSRF does not apply because cookie authentication is not accepted as authorization for runtime control routes.

**TH-HARNESS-REQ-451**
When test routes are enabled and a harness-owned API or browser origin is configured, runtime control routes MUST reject requests whose request origin is not the harness-declared browser origin or harness-declared API origin, or whose request host does not match the harness-owned API origin. Same-process health and readiness probes MUST use explicitly declared non-destructive health endpoints rather than runtime control routes. Runtime control routes MUST NOT enable permissive CORS. A rejected origin or host MUST fail before any runtime-control mutation with `403`, `error.code=test_route_forbidden`.
...
normalize_cleanup_candidate(path):
  ...
  reject protected repository roots such as source, spec, config, generated-input, and VCS roots when they are named as cleanup candidates
  lstat path
  if path is symlink:
...
| TH-HARNESS-AC-008 | Section 12         | Reset route                      | Browser test runtime with test route token                                   | Reset route success, auth rejection, origin/host rejection, concurrent reset, timeout, partial failure fixtures | Expected HTTP statuses from Section 12                         | HTTP JSON response                                     | n/a                                                          | Reset response validates schema; tainted stack marker on partial failure; no permissive CORS headers | Default runtime exposes route, wrong host/origin reaches mutation, or wildcard CORS is emitted | tainted stack restarted before further work             |
| TH-HARNESS-AC-009 | Section 13         | Cleanup path guard               | Synthetic registry with safe and unsafe paths                                | Cleanup guard unit and `CARTULARY_CLEANUP_DRY_RUN=1 make clean`                           | `0` for safe dry-run; nonzero for unsafe synthetic path        | Dry-run lines match format                             | Bounded guard diagnostic on unsafe path                      | Candidate list or guard evidence                                                                   | Empty path, `/`, `.`, `..`, traversal, protected root, outside-repo path, or symlink-following accepted | no deletion in dry-run                                  |
...
| TH-HARNESS-AC-022 | Sections 1, 4, 5, 8, 10 | Frontend readiness harness metadata | Current frontend registry/maps plus malformed namespace, missing a11y target, and raw-only a11y artifact fixtures | `make task-surface-report TASK_SURFACE_REPORT_ARGS=--all`; JSON shape checks; `make explain-phase PHASE_NAMESPACE=frontend PHASE=FE-P3`; ambiguity fixture for `PHASE=FE-P3`; a11y summary schema validation | Success only when the public target, frontend namespace, frontend maps, and normalized a11y summary are all valid | Bounded report or explain output | Empty on success; bounded usage diagnostic for ambiguous namespace fixture | Public registry includes `browser-e2e-a11y`; frontend maps own `FE-*` rows; `cartulary.frontend_accessibility_summary.v1` validates; frontend ledger artifacts remain generated | Filename-only or title-only `FE-*` row claims pass, `PHASE=FE-P3` without namespace is accepted, or raw third-party a11y output substitutes for the summary | no child browser work required for metadata fixtures |

### 17.1 Requirement-to-Acceptance Traceability

| Requirement range         | Owner section                      | Acceptance criteria                                     |
| ------------------------- | ---------------------------------- | ------------------------------------------------------- |
| `TH-HARNESS-REQ-001..049` | Status, scope, authority, purpose  | TH-HARNESS-AC-013, TH-HARNESS-AC-015, TH-HARNESS-AC-016, TH-HARNESS-AC-022 |
| `TH-HARNESS-REQ-050..099` | Public command surface             | TH-HARNESS-AC-001, TH-HARNESS-AC-004, TH-HARNESS-AC-005, TH-HARNESS-AC-018, TH-HARNESS-AC-020, TH-HARNESS-AC-022 |
| `TH-HARNESS-REQ-100..149` | Configuration                      | TH-HARNESS-AC-002, TH-HARNESS-AC-003, TH-HARNESS-AC-021, TH-HARNESS-AC-022 |
...
| `TH-HARNESS-REQ-250..299` | Artifacts and schemas              | TH-HARNESS-AC-000, TH-HARNESS-AC-004, TH-HARNESS-AC-015, TH-HARNESS-AC-019, TH-HARNESS-AC-022 |
| `TH-HARNESS-REQ-300..349` | Failure and exit codes             | TH-HARNESS-AC-013, TH-HARNESS-AC-014                    |
| `TH-HARNESS-REQ-350..399` | Scheduler                          | TH-HARNESS-AC-006, TH-HARNESS-AC-018, TH-HARNESS-AC-021, TH-HARNESS-AC-022 |
...
| `TH-HARNESS-REQ-600..649` | Security and redaction             | TH-HARNESS-AC-003, TH-HARNESS-AC-011, TH-HARNESS-AC-015 |
