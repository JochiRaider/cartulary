...
| `doctor` | `cartulary.harness.command.doctor.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | verify required local tools and versions |
| `bootstrap` | `cartulary.harness.command.bootstrap.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | install pinned tools and frontend/browser dependencies |
| `bootstrap-node-runtime` | `cartulary.harness.command.bootstrap_node_runtime.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | install the pinned repo-local Node runtime |
| `frontend-toolchain` | `cartulary.harness.command.frontend_toolchain.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | verify the pinned Node/pnpm toolchain |
| `frontend-install` | `cartulary.harness.command.frontend_install.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | install workspace dependencies |
| `playwright-install` | `cartulary.harness.command.playwright_install.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | install browser dependencies |
| `db-up` | `cartulary.harness.command.db_up.v1` | helper_only | service_summary | `cartulary.tool_run_summary.v2` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | start local Postgres and MinIO, then initialize the default MinIO bucket |
| `db-reset` | `cartulary.harness.command.db_reset.v1` | helper_only | service_summary | `cartulary.tool_run_summary.v2` | `destructive_safety` (Section 13), `failure_normalization` (Section 9) | recreate the local database only; does not reset object storage |
| `services-up` | `cartulary.harness.command.services_up.v1` | helper_only | service_summary | `cartulary.tool_run_summary.v2` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | start local Postgres and MinIO, then wait until ready |
| `minio-init` | `cartulary.harness.command.minio_init.v1` | helper_only | service_summary | `cartulary.tool_run_summary.v2` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | create the default local MinIO bucket if needed |
...
| `generate` | `cartulary.harness.command.generate.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | regenerate sqlc and contract-derived outputs |
| `generate-drift` | `cartulary.harness.command.generate_drift.v1` | check | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | fail on generated artifact drift |
| `generated-artifact-policy-check` | `cartulary.harness.command.generated_artifact_policy_check.v1` | check | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | fail on generated artifact marker and lint-scope policy drift |
| `json-shape-check` | `cartulary.harness.command.json_shape_check.v1` | check | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | fail on contract, manifest, and JSON bootstrap shape drift |
| `toolchain-drift` | `cartulary.harness.command.toolchain_drift.v1` | check | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | fail on repo-control toolchain pin drift |
| `migration-drift` | `cartulary.harness.command.migration_drift.v1` | check | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | verify migrations against a scratch database |
| `phase-ledgers` | `cartulary.harness.command.phase_ledgers.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | regenerate committed phase coverage ledgers |
| `phase-ledger-drift` | `cartulary.harness.command.phase_ledger_drift.v1` | check | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | fail on phase coverage ledger drift |
| `phase-schedules` | `cartulary.harness.command.phase_schedules.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | regenerate committed phase-derived schedules |
| `phase-schedule-drift` | `cartulary.harness.command.phase_schedule_drift.v1` | check | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | fail on phase-derived schedule drift |
| `agent-finalize` | `cartulary.harness.command.agent_finalize.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | refresh and validate harness-maintenance artifacts before verification |
| `benchmark-claim-check` | `cartulary.harness.command.benchmark_claim_check.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | validate retained Core 05 benchmark claim artifacts |
...
| `phase-slice` | `cartulary.harness.command.phase_slice.v1` | helper_only | scheduler_summary_with_artifacts | `cartulary.tool_run_summary.v2` | `scheduler_orchestration` (Section 10), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run the selected phase manifest-row slice |
| `service-backed-slice` | `cartulary.harness.command.service_backed_slice.v1` | helper_only | scheduler_summary_with_artifacts | `cartulary.tool_run_summary.v2` | `scheduler_orchestration` (Section 10), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run the selected phase service-backed manifest-row slice |
| `backend-unit` | `cartulary.harness.command.backend_unit.v1` | test,check,ci | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run pure backend unit evidence |
| `backend-store` | `cartulary.harness.command.backend_store.v1` | test,check,ci | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run service-backed store-domain evidence |
| `backend-integration` | `cartulary.harness.command.backend_integration.v1` | test,check,ci | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run backend integration evidence |
| `backend-process` | `cartulary.harness.command.backend_process.v1` | test,check,ci | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run backend process evidence |
...
| `go-test-duration-baselines` | `cartulary.harness.command.go_test_duration_baselines.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | refresh Go test duration baselines |
| `go-test-duration-baseline-coverage` | `cartulary.harness.command.go_test_duration_baseline_coverage.v1` | check | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | verify Go shard baseline coverage |
| `go-test-duration-baseline-drift` | `cartulary.harness.command.go_test_duration_baseline_drift.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | verify Go shard baseline freshness |
| `browser-e2e-duration-baselines` | `cartulary.harness.command.browser_e2e_duration_baselines.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | refresh browser spec duration baselines |
| `browser-e2e-duration-baseline-drift` | `cartulary.harness.command.browser_e2e_duration_baseline_drift.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | verify browser spec baseline freshness |
| `service-backed-make-target-duration-baselines` | `cartulary.harness.command.service_backed_make_target_duration_baselines.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | refresh scheduler work-unit duration baselines |
| `service-backed-make-target-duration-baseline-drift` | `cartulary.harness.command.service_backed_make_target_duration_baseline_drift.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | verify scheduler work-unit duration baseline freshness |
| `harness-smoke-duration-baselines` | `cartulary.harness.command.harness_smoke_duration_baselines.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | refresh harness smoke duration baselines |
| `harness-smoke-duration-baseline-drift` | `cartulary.harness.command.harness_smoke_duration_baseline_drift.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | verify harness smoke baseline freshness |
| `scheduler-event-order-drift` | `cartulary.harness.command.scheduler_event_order_drift.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | verify scheduler event stream ordering |
| `scheduler-summary-timing-drift` | `cartulary.harness.command.scheduler_summary_timing_drift.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | verify scheduler summary timing accounting |
| `frontend-typecheck` | `cartulary.harness.command.frontend_typecheck.v1` | test,check,ci | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run TypeScript type checking |
| `frontend-unit` | `cartulary.harness.command.frontend_unit.v1` | test,check,ci | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run the frontend unit suite |
| `frontend-import-boundary-check` | `cartulary.harness.command.frontend_import_boundary_check.v1` | check | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | enforce frontend import ownership boundaries |
| `lint-biome` | `cartulary.harness.command.lint_biome.v1` | check | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run authored frontend Biome checks |
| `lint-scripts` | `cartulary.harness.command.lint_scripts.v1` | check | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run JavaScript orchestration script Biome checks |
| `lint-shell` | `cartulary.harness.command.lint_shell.v1` | check | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run warning-only ShellCheck over tracked shell scripts |
| `format` | `cartulary.harness.command.format.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | format authored Go and frontend sources |
| `browser-e2e` | `cartulary.harness.command.browser_e2e.v1` | test,check,ci | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run isolated browser E2E suites through one batch stack |
| `browser-e2e-webserver-backed` | `cartulary.harness.command.browser_e2e_webserver_backed.v1` | test,check,ci | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run shared-stack browser E2E batch |
| `browser-e2e-stateful` | `cartulary.harness.command.browser_e2e_stateful.v1` | test,check,ci | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run isolated stateful browser E2E batch |
| `browser-e2e-measurement` | `cartulary.harness.command.browser_e2e_measurement.v1` | test,ci | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run ordinary browser measurement evidence |
| `browser-e2e-visual` | `cartulary.harness.command.browser_e2e_visual.v1` | test,check,ci | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `service_lifecycle` (Section 11), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run isolated visual browser E2E |
| `test-fast` | `cartulary.harness.command.test_fast.v1` | test,check,ci | aggregate_summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run the narrower local verification loop |
| `test` | `cartulary.harness.command.test.v1` | test,check,ci | aggregate_summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run the authoritative full test corpus |
| `lint` | `cartulary.harness.command.lint.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run backend, frontend, script, and shell lint/type checks |
| `go-vulncheck` | `cartulary.harness.command.go_vulncheck.v1` | check | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `security_boundary` (Section 15), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run Go vulnerability scanning over authored package roots |
| `go-gosec-targeted` | `cartulary.harness.command.go_gosec_targeted.v1` | check | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `security_boundary` (Section 15), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run targeted Go security static analysis |
| `go-gosec-audit` | `cartulary.harness.command.go_gosec_audit.v1` | check | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `security_boundary` (Section 15), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run warning-only Go security audit profiles |
| `check` | `cartulary.harness.command.check.v1` | check | scheduler_summary_with_artifacts | `cartulary.tool_run_summary.v2` | `scheduler_orchestration` (Section 10), `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run the developer verification gate |
| `ci` | `cartulary.harness.command.ci.v1` | ci | aggregate_summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run the provider-neutral CI entrypoint |
| `release-check` | `cartulary.harness.command.release_check.v1` | release-check | aggregate_summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | run check, extended harness, release artifacts, and build verification |
| `build` | `cartulary.harness.command.build.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | build backend binaries with embedded web assets |
| `build-server` | `cartulary.harness.command.build_server.v1` | check,helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | build the server binary |
| `build-migrate` | `cartulary.harness.command.build_migrate.v1` | check,helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | build the migration binary |
| `build-web` | `cartulary.harness.command.build_web.v1` | helper_only | summary_with_artifacts | `cartulary.tool_run_summary.v2` | `evidence_normalization` (Section 8), `failure_normalization` (Section 9) | build frontend web assets |
...
| `cartulary.agent_finalize_summary.v1`           | `tools/schemas/cartulary.agent_finalize_summary.v1.schema.json`           | present           | Agent finalizer          | Before `agent-finalize` exits.            |
...
| Agent finalizer summary                              | Agent finalizer                                 | `agent-finalize/finalize-summary.json`                          | `cartulary.agent_finalize_summary.v1`                         | Ordered substeps, skipped steps, updated files, `RESULTS_DIR`, child artifact refs     | Retained.                                                    |
...
`agent-finalize` MUST run only the following direct child targets when `RESULTS_DIR` is unset: `phase-ledgers`, `phase-ledger-drift`, `phase-schedules`, `phase-schedule-drift`, `json-shape-check`, and `go-test-duration-baseline-coverage`.
...
After retained-run validation succeeds, `agent-finalize` MUST run the duration refresh targets `go-test-duration-baselines`, `browser-e2e-duration-baselines`, `service-backed-make-target-duration-baselines`, and `harness-smoke-duration-baselines`; then it MUST run `go-test-duration-baseline-coverage`, `duration-baseline-drift-suite`, `scheduler-event-order-drift`, and `scheduler-summary-timing-drift TARGET=check`. Duration-baseline refreshes remain advisory harness planning data and MUST NOT become benchmark claims or product performance conformance evidence.
Verified by: TH-HARNESS-AC-019
...
`agent-finalize` MUST retain `agent-finalize/finalize-summary.json` with schema ID `cartulary.agent_finalize_summary.v1`. The summary MUST include selected substeps, skipped substeps, updated files, `RESULTS_DIR`, failure records, and child artifact references. Human summary output MUST include one compact `[FINALIZE]` line before the ordinary `[RESULT]` line. Machine output MUST remain exactly one `cartulary.tool_run_summary.v2` JSON object; callers MUST use the `finalize_summary` artifact reference to read command-specific finalizer details.
...
`agent-finalize RESULTS_DIR=<dir>` MUST perform retained-run validation before any duration-baseline refresh target mutates committed baseline artifacts. That validation MUST reject failed, incomplete, contaminated, or non-warm retained evidence before the first mutating refresh child starts.
...
| TH-HARNESS-AC-019 | Section 8.2        | Agent finalizer                  | Fake Make fixture plus valid, missing, failed, incomplete, contaminated, and non-warm retained run fixtures | `make agent-finalize`; `RESULTS_DIR=<dir> make agent-finalize`; `CARTULARY_OUTPUT_MODE=machine make agent-finalize` | Success for coherent maintenance inputs; fail-fast for first failed child or invalid retained run | One `[FINALIZE]` line then bounded result/artifact lines; machine emits one JSON object | Bounded failure diagnostic naming failed step | `agent-finalize/finalize-summary.json`, child summaries/logs, and `finalize_summary` artifact ref | Excluded targets run, mutation starts after invalid `RESULTS_DIR`, machine output requires log parsing, or skipped-after-failure steps are absent | No cleanup or destructive command is run               |
