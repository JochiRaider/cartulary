...
| `service_summary`                  | `db-up`, `db-reset`, `services-up`, `minio-init`                                                  |                 yes | One `cartulary.tool_run_summary.v2` JSON object plus LF | Empty after wrapper starts                                                            | Tool-run summary and service diagnostics where applicable | Same schema with service failure fields                                |
