...
| MD-S7-0006 | Scheduler lanes | Scheduler lanes are logical scheduling constraints only, not physical host, service, Docker, Postgres, object-store, or browser capacity guarantees. | `AUTH-0011`, `PRES-0003`, `RES-*` | `maintainer_decision` |
