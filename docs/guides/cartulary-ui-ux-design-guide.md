...
| Shell composition      | §5.2 defines tabs, switcher, ordering, optional surfaces, saved-view placement, keyboard behavior, and rejected alternatives; §5.8 defines authenticated root landing compositions and deployment-administration menu derivation; §5.10 defines administrative audit view presentation. |
...
| P4-2    | P4       | All acceptance criteria    | N/A                                                            | editorial          | Normalized acceptance-criteria heading and binary style.                                                         | R2-AC-001..R2-AC-107             |
