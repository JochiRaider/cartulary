...
- `internal/testutil/phase2test.StartStore()`, `SeedLocalUserRecord()`, `CreateIncidentInStore()`, `CreateMembershipInStore()`, and `SnapshotIncidentCreateReplaySideEffects()` own the store-backed Phase 2 helper seam used by `backend-store`.
...
| U-3-GRID-02 | Timeline grid row bindings carry `record_id` and `row_version` and do not use visible row index as mutation identity.                                                                                                                  | REQ-01-015..REQ-01-017, REQ-01-022, REQ-03-033..REQ-03-035                                     | AC-001, AC-009, AC-013, AC-047, AC-231 |
| U-3-GRID-03 | A local edit in a sorted or filtered Timeline viewport emits a patch with the original bound `record_id`, `base_row_version`, and `field_key`.                                                                                         | REQ-01-022, REQ-01-035, REQ-01-057..REQ-01-060, REQ-03-033..REQ-03-035                         | AC-009, AC-013, AC-125, AC-126, AC-231 |
