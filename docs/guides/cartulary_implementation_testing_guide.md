...
| I-4-08 | Interactive auto-resolution uses only the explicit exact-match eligibility contract, creates `provenance='auto_match'` links with `confidence=100` only for eligible committed Timeline tokens, never strips hedge or punctuation forms into matches, and rolls back cleanly when the owning patch fails. | REQ-01-057..REQ-01-088, REQ-01-228..REQ-01-239, REQ-01-315..REQ-01-316, REQ-01-568, REQ-02-163..REQ-02-185, REQ-03-205..REQ-03-216, REQ-03-276..REQ-03-279 | AC-205, AC-388..AC-392 |
