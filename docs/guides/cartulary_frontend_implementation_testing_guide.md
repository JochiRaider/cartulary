...
| FE-U-P3-02 | Unit | Translate vendor row/column coordinates to `record_id + field_key` for edit, copy, paste, fill-down, selection, focus, and anchor assertions. | Core 01 Section 3.3.4; Core 03 Sections 4.1, 18, and 19; development guide Sections 6.3 and 6.9 | `REQ-01-034`, `REQ-01-035`, `REQ-01-058`, `REQ-03-217`..`REQ-03-222`, `REQ-03-263`..`REQ-03-265` | `AC-003`, `AC-005`, `AC-009`, `AC-040`, `AC-043`, `AC-124`..`AC-127`, `AC-184`, `AC-185`, `AC-231`, `AC-354`, `AC-394`..`AC-396` | `make frontend-unit` | `product_conformance` |
...
| FE-B-P3-01 | Browser integration | Verify sort, filter, group, paste, fill-down, scroll-to-cell, group expand/collapse, and anchor assertions through browser command helpers. | Core 03 Sections 4.1, 14, 18, and 19; implementation guide Section 14.9A | `REQ-03-217`..`REQ-03-235`, `REQ-03-263`..`REQ-03-265` | `AC-003`, `AC-005`, `AC-013`, `AC-014`, `AC-024`..`AC-026`, `AC-040`, `AC-043`, `AC-044`, `AC-047`, `AC-231`, `AC-354`, `AC-360`, `AC-363`, `AC-364`, `AC-394`..`AC-396` | `make browser-e2e-support`; `make browser-e2e-webserver-backed` | `product_conformance` |
