...
| FE-GUIDE-AC-026 | Frontend row accounting validation uses `cartulary.frontend_row_accounting.v3` and includes accounting scope, command ID, registry/map/guide digests, run root, scenario results, row results, required-target closure, and stale or not-closed reasons. |
