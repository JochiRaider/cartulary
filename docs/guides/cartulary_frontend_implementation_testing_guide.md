...
| FE-U-P0-03 | Unit | Verify stable selector and test-id builders derive identifiers from stable IDs, registry-backed `view_schema_id` values, and selector-relevant closed vocabularies rather than visible labels. | Core 01 Section 7.4; Core 02 Section 18; development guide Section 6.4 | `REQ-01-307`..`REQ-01-311`, `REQ-02-222`, `REQ-02-223` | `AC-076`..`AC-084`, `AC-116`..`AC-122`, `AC-137`..`AC-145`, `AC-231`, `AC-252`, `AC-253`, `AC-277`, `AC-284`..`AC-287`, `AC-300`..`AC-303` | `make frontend-unit` | `product_conformance` |
