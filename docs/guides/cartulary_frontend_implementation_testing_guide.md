...
| FE-H-12 | Accessibility names, ARIA, and state communication | P1 through P11 | UI/UX guide Section 14; `docs/design.md` Accessibility Direction | `make browser-e2e-a11y`; `make browser-e2e-a11y-preflight` | Active tab/surface/menu/tree/group/conflict/save/presence/evidence states are named and communicated without color alone. |
