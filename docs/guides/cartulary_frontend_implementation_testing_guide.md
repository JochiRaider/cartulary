...
| FE-GUIDE-AC-029 | Visual fixtures are governed by `tools/frontend_visual_fixture_registry.json`, and missing fixtures block affected rows instead of using generic TODO text. |
