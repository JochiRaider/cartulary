...
| FE-A11Y-P8-01 | Accessibility | Verify sort, filter, group, saved-view menu, active chips, group expand-collapse, and default/startup controls are keyboard reachable and announced. | UI/UX guide Sections 7, 10.5, 14 | `N/A: design_direction; Core owner not claimed` | `R2-AC-027`..`R2-AC-032`, `R2-AC-051`..`R2-AC-054`, `R2-AC-080`..`R2-AC-086`, `D-AC-009`, `D-AC-012` | `make browser-e2e-a11y-preflight` | `design_direction` |
