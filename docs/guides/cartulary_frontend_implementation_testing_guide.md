...
| FE-A11Y-P5-01 | Accessibility | Verify mention chip states and manual-resolution controls have accessible names, visible focus, and non-color-only distinction. | UI/UX guide Sections 10.3, 10.5, 14; `docs/design.md` Accessibility Criteria | `N/A: design_direction; Core owner not claimed` | `R2-AC-040`..`R2-AC-044`, `R2-AC-080`..`R2-AC-086`, `D-AC-050`, `D-AC-051` | `make browser-e2e-a11y-preflight` | `design_direction` |
...
| FE-H-04 | Sync-engine pending queue and replay behavior | P4 through P10 | Core 01 Section 3.3.6; Core 03 Sections 4.1, 4.4, and 15 | `make frontend-unit`; `make browser-e2e-stateful` | Pending creates, patches, paste batches, retries, failures, and replay are ordered by stable mutation identifiers and public route results. |
