...
| FE-U-P3-02 | Unit | Translate vendor row/column coordinates to `record_id + field_key` for edit, copy, paste, fill-down, selection, focus, and anchor assertions. | Core 01 Section 3.3.4; Core 03 Sections 4.1 and 4.13; development guide Sections 6.3 and 6.9 | `REQ-01-034`, `REQ-01-035`, `REQ-01-058`, `REQ-03-217`..`REQ-03-222`, `REQ-03-263`..`REQ-03-265` | `AC-003`, `AC-005`, `AC-009`, `AC-040`, `AC-043`, `AC-124`..`AC-127`, `AC-184`, `AC-185`, `AC-231`, `AC-354`, `AC-394`..`AC-396` | `make frontend-unit` | `product_conformance` |
...
| FE-B-P3-01 | Browser integration | Verify sort, filter, group, paste, fill-down, scroll-to-cell, group expand/collapse, and anchor assertions through browser command helpers. | Core 03 Sections 4.1, 14, and 4.13; implementation guide Section 14.9A | `REQ-03-217`..`REQ-03-235`, `REQ-03-263`..`REQ-03-265` | `AC-003`, `AC-005`, `AC-013`, `AC-014`, `AC-024`..`AC-026`, `AC-040`, `AC-043`, `AC-044`, `AC-047`, `AC-231`, `AC-354`, `AC-360`, `AC-363`, `AC-364`, `AC-394`..`AC-396` | `make browser-e2e-support`; `make browser-e2e-webserver-backed` | `product_conformance` |
...
| FE-V-P8-01 | Visual regression | Capture saved-view selector, active chips, grouped result, group row, default/startup state indicator, and empty successful query fixtures. | UI/UX guide Sections 7, 10.5, 13; visual golden guide Sections 2, 3, 5 | `N/A: design_direction; Core owner not claimed` | `R2-AC-027`..`R2-AC-032`, `R2-AC-051`..`R2-AC-054`, `R2-AC-073`..`R2-AC-079`, `R2-RDG-AC-001`..`R2-RDG-AC-010` | `make browser-e2e-visual`; `TODO: add missing fixtures to apps/web/e2e/workbook.visual.spec.ts where absent` | `design_direction` |
...
| FE-V-P10-01 | Visual regression | Capture Task Requests or Decisions, Parties link state, Communications Log, Handoff, Status Review, Lesson, keyboard focus, frozen column, resize handle, and fill-down fixtures. | UI/UX guide Sections 11, 13, 14; visual golden guide Sections 2, 3, 5 | `N/A: design_direction; Core owner not claimed` | `R2-AC-055`..`R2-AC-058`, `R2-AC-073`..`R2-AC-086`, `R2-RDG-AC-001`..`R2-RDG-AC-010` | `make browser-e2e-visual`; `TODO: add missing fixtures to apps/web/e2e/workbook.visual.spec.ts where absent` | `design_direction` |
...
| FE-H-09 | Browser command helpers | P3 through P10 | Core 03 Sections 4.1, 14, and 4.13; implementation guide Section 14.9A | `make browser-e2e-support`; `make browser-e2e-webserver-backed` | Helpers cover sort, filter, group, paste, fill-down, scroll-to-cell, group expand/collapse, and anchor assertions; resize helpers remain support/design measurement only. |
...
| FE-H-11 | Keyboard and focus traversal | P1 through P11 | Core 03 Sections 4.1 and 4.13; UI/UX guide Section 14 | `make browser-e2e-support`; `make browser-e2e-a11y`; `make browser-e2e-a11y-preflight` | Keyboard access, visible focus, focus restoration, edit entry/exit, menus, switchers, inspector controls, conflict resolver, and `Esc` priority are covered. |
...
| FE-VFIX-04 | Row-gutter presence | P7 | `make browser-e2e-visual` |
| FE-VFIX-05 | Evidence affordance | P6 | `make browser-e2e-visual`; `TODO: add missing fixture where absent` |
| FE-VFIX-06 | Grouped result | P8 | `make browser-e2e-visual` |
...
| FE-VFIX-09 | Frozen column | P3, P10 | `make browser-e2e-visual` |
| FE-VFIX-10 | Resize handle | P3, P10 | `make browser-e2e-visual` |
| FE-VFIX-11 | Drag-fill handle | P3, P10 | `make browser-e2e-visual` |
| FE-VFIX-12 | Edit cell | P3, P4, P10 | `make browser-e2e-visual` |
| FE-VFIX-13 | Tree/group row | P3, P8, P10 | `make browser-e2e-visual` |
| FE-VFIX-14 | Exposed theme states | P11 | `make browser-e2e-visual` |
| FE-VFIX-15 | Empty successful query | P3, P4, P8 | `make browser-e2e-visual` |
...
Each `tools/frontend_phase_maps/fe_p*_test_map.json` file MUST declare `schema_id="cartulary.frontend_phase_test_map.v2"`, `phase_namespace="frontend"`, matching `phase_id`, and `rows[]`. Each row MUST include `id`, `layer`, `evidence_class`, `default_check_required`, `owner_refs[]`, `core_req_ids[]`, `core_ac_ids[]`, `support_or_design_ac_ids[]`, `targets[]`, `scenario_titles[]`, `claim_status`, `claim`, and `out_of_scope`. `default_check_required` means the row belongs in the local default-check projection; explicit browser, visual, accessibility, support, and claim-publication evidence remains reachable through its direct target even when this field is `false`.
