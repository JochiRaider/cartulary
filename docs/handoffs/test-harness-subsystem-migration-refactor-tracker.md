...
| Active start | T-042 closure checkpoint based on clean WS-10 activation commit `26f2b17e` |
| Active tasks | T-043 |
...
| T-043 | Delete phase/subsystem registries and maps | WS-10 | IN_PROGRESS | T-016,T-022,T-027,T-039 | Deletion manifest/zero scan | Unified catalog is sole owner. |
