...
| `NFA-DESIGN-001` | Define Network Analysis design-direction application | `WS-17` | `TODO` | `NFA-C03-001` | frontend design | UI ACs | `docs/design.md` | Narrow token/layout/interaction guidance | `make lint-markdown` | UI uses existing design tokens without claiming product conformance |
