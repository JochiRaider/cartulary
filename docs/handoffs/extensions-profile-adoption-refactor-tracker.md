...
| Execution status | `EPA-00` through `EPA-07` are `DONE`; `EPA-08` is `IN_PROGRESS`; `EPA-09` through `EPA-12` are `NOT_STARTED` |
...
| EPA-08 | `IN_PROGRESS` | EPA-04 | wait for final rollout | Reference Pack adoption activated |
