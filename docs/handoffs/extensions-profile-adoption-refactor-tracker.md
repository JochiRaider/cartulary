...
| Execution status | `EPA-00` through `EPA-10` are `DONE`; `EPA-11` is `IN_PROGRESS`; `EPA-12` is `NOT_STARTED` |
...
| EPA-11 | `IN_PROGRESS` | EPA-10 | no dual path | obsolete-path removal and static DAG guards activated |
