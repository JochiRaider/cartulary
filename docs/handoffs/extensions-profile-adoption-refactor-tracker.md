...
| Execution status | `EPA-00` through `EPA-08` are `DONE`; `EPA-09` is `IN_PROGRESS`; `EPA-10` through `EPA-12` are `NOT_STARTED` |
...
| EPA-09 | `IN_PROGRESS` | EPA-04 | wait for final rollout | Snapshot and Reporting adoption activated |
