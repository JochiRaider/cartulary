...
| Execution status | `EPA-00` through `EPA-06` are `DONE`; `EPA-07` is `IN_PROGRESS`; `EPA-08` through `EPA-12` are `NOT_STARTED` |
...
| EPA-07 | `IN_PROGRESS` | EPA-04 | wait for final rollout | Incident Portability adoption activated |
