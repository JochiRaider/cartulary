...
| Execution status | `EPA-00` through `EPA-09` are `DONE`; `EPA-10` is `IN_PROGRESS`; `EPA-11` and `EPA-12` are `NOT_STARTED` |
...
| EPA-10 | `IN_PROGRESS` | EPA-05..09 | evidence/docs only | Harness ownership and documentation reconciliation activated |
