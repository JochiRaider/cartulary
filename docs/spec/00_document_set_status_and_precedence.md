...
This revision records a behavior-affecting closure for deployment administration entry, imported-incident initial access, Reference Pack list search and filters, prohibited aggregate administration concepts, and the Timeline operational-field refactor. With those contracts adopted in Core 00 through Core 04, current-profile behavior, profile boundaries, and implementation-conformance scope are closed again here.
