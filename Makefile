...
$(SQLC_BIN): FORCE Makefile tools/harness/readiness/bootstrap-go-tool.sh $(BOOTSTRAP_GO_TOOL_IMPL) $(CACHE_ARTIFACT_SCRIPT)
...
$(GOOSE_BIN): FORCE Makefile tools/harness/readiness/bootstrap-go-tool.sh $(BOOTSTRAP_GO_TOOL_IMPL) $(CACHE_ARTIFACT_SCRIPT)
...
$(STATICCHECK_BIN): FORCE Makefile tools/harness/readiness/bootstrap-go-tool.sh $(BOOTSTRAP_GO_TOOL_IMPL) $(CACHE_ARTIFACT_SCRIPT)
...
$(GOVULNCHECK_BIN): FORCE Makefile tools/harness/readiness/bootstrap-go-tool.sh $(BOOTSTRAP_GO_TOOL_IMPL) $(CACHE_ARTIFACT_SCRIPT)
...
$(GOSEC_BIN): FORCE Makefile tools/harness/readiness/bootstrap-go-tool.sh $(BOOTSTRAP_GO_TOOL_IMPL) $(CACHE_ARTIFACT_SCRIPT)
...
$(CYCLONEDX_GOMOD_BIN): FORCE Makefile tools/harness/readiness/bootstrap-go-tool.sh $(BOOTSTRAP_GO_TOOL_IMPL) $(CACHE_ARTIFACT_SCRIPT)
...
$(SYFT_BIN): FORCE Makefile tools/harness/readiness/bootstrap-go-tool.sh $(BOOTSTRAP_GO_TOOL_IMPL) $(CACHE_ARTIFACT_SCRIPT)
...
$(SERVER_BIN): FORCE $$(SERVER_BUILD_INPUTS) $(EMBEDDED_WEB_ASSET_STAMP) $(EMBEDDED_WEB_ASSET_ARCHIVE) $(EMBEDDED_WEB_ASSET_READY_STAMP) tools/harness/backend/build-go-artifact.sh $(BUILD_GO_ARTIFACT_IMPL) $(CACHE_ARTIFACT_SCRIPT)
...
$(SERVER_HARNESS_BIN): FORCE $$(SERVER_BUILD_INPUTS) $(EMBEDDED_WEB_ASSET_STAMP) $(EMBEDDED_WEB_ASSET_ARCHIVE) $(EMBEDDED_WEB_ASSET_READY_STAMP) tools/harness/backend/build-go-artifact.sh $(BUILD_GO_ARTIFACT_IMPL) $(CACHE_ARTIFACT_SCRIPT)
...
$(MIGRATE_BIN): FORCE $$(MIGRATE_BUILD_INPUTS) tools/harness/backend/build-go-artifact.sh $(BUILD_GO_ARTIFACT_IMPL) $(CACHE_ARTIFACT_SCRIPT)
...
$(OPERATOR_BIN): FORCE $$(OPERATOR_BUILD_INPUTS) $(EMBEDDED_WEB_ASSET_STAMP) $(EMBEDDED_WEB_ASSET_ARCHIVE) $(EMBEDDED_WEB_ASSET_READY_STAMP) tools/harness/backend/build-go-artifact.sh $(BUILD_GO_ARTIFACT_IMPL) $(CACHE_ARTIFACT_SCRIPT)
