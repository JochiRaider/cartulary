...
GO_RUN_ENV := GOTOOLCHAIN=$(GO_TOOLCHAIN) GOCACHE=$(GO_CACHE_DIR) GOMODCACHE=$(GO_MOD_CACHE_DIR)
...
export CARTULARY_OUTPUT_MODE VERBOSE CI_VERBOSE CI CARTULARY_TEST_RESULTS_DIR CARTULARY_TEST_RUN_ID CARTULARY_TEST_INVENTORY GOTOOLCHAIN GO_TOOLCHAIN GO_TOOLCHAIN_READY
