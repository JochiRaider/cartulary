...
export function useNetworkFlowSavedGraphController(options: {
  ...
  return {
    ...
    reloadGraph: controller.reconcileGraph,
    ...
    prepareCurrentQuery: controller.prepareCurrentQuery,
    reloadOperationGraph: controller.reloadOperationGraph,
    resumeOperationObservation: controller.resumeOperationObservation,
