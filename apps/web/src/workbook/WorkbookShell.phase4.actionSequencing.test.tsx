...
describe("Phase 4 Timeline workbook action sequencing", () => {
  ...
  it("FE-U-P4-01 sends Timeline actions with the current row version after earlier workbook mutations", async () => {
  ...
  it("FE-U-P4-01 waits for a pending material autosave before supersede dispatch", async () => {
  ...
  it("FE-U-P4-01 keeps action result row versions ahead of stale projection reloads", async () => {
    const routedFetch = queueTwoRowInitialState({
      recordOneCaptureState: "rough",
      recordOneRowVersion: 1,
    });
