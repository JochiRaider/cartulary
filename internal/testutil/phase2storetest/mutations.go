...
func LookupOwnerMutations(t testing.TB, db postgres.DB, selector MutationSelector, owner MutationOwner) []AuditEventRecord {
	t.Helper()
...
func CountMutationArtifacts(t testing.TB, db postgres.DB, selector MutationSelector, owners ...MutationOwner) int {
	t.Helper()
...
func RequireNoMutationArtifacts(t testing.TB, db postgres.DB, selector MutationSelector, owners ...MutationOwner) {
	t.Helper()
...
func lookupAuditEventsBySelector(t testing.TB, db postgres.DB, selector MutationSelector) []AuditEventRecord {
	t.Helper()
