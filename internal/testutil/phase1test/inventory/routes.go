...
var phase1RouteHarnessClasses = []RouteHarnessClass{
...
func Phase1RouteHarnessClasses() []RouteHarnessClass {
	return append([]RouteHarnessClass(nil), phase1RouteHarnessClasses...)
}
...
func ValidateRouteInventory(t testing.TB, routes []RouteInventoryEntry) {
	...
	for _, route := range routes {
		...
		for _, harness := range phase1RouteHarnessClasses {
...
func routeHarnessRequirements(required ...RouteHarnessClass) map[RouteHarnessClass]RouteHarnessRequirement {
	requirements := make(map[RouteHarnessClass]RouteHarnessRequirement, len(phase1RouteHarnessClasses))
	for _, harness := range phase1RouteHarnessClasses {
