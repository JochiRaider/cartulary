...
func TestPhase10_I_10_02_FreshEnvironmentRestoreWorkbookConsistency(t *testing.T) {
	...
	verificationBody := phase10RequireStoredArtifactProof(t, fixture.BackupStorage, verification.ArtifactProof)
	verificationPath := phase10WriteEvidenceArtifact(t, "phase-e-backup-restore", "restore-verification.json", verificationBody)
