...
func RequireTimelineRecordMutation(t testing.TB, db *sql.DB, changeSetID string, expectation TimelineRecordMutationExpectation) ChangeSetMutationRow {
	t.Helper()
...
func RequireRecordLinkCreateMutation(t testing.TB, db *sql.DB, changeSetID string, expectation RecordLinkMutationExpectation) ChangeSetMutationRow {
	t.Helper()
