...
func newPhase3StoreFixture(t testing.TB, harness *storetest.StoreHarness, suffix string, incidentTxn string) (*phase3TimelineCommands, authn.UserRecord, uuid.UUID) {
	t.Helper()
