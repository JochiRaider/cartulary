...
func NewIncidentBundleSourcePort() sourceport.Port {
	descriptor := sourceport.Descriptor{
		...
		Paths: []sourceport.Path{
			{LogicalPath: timelineBundleProfilesPath, ContentRole: "source_rows", Versions: []int{4}, StableIdentity: []string{"incident_id"}, StableIdentityInvariantID: "timeline.source_identity_admitted"},
			{LogicalPath: timelineBundleRecordsPath, ContentRole: "source_rows", Versions: []int{4}, StableIdentity: []string{"record_id"}, StableIdentityInvariantID: "timeline.source_identity_admitted"},
			{LogicalPath: timelineBundleProvenancePath, ContentRole: "source_rows", Versions: []int{4}, StableIdentity: []string{"record_id", "source_row_ordinal", "source_column_ordinal", "source_identity_sha256"}, StableIdentityInvariantID: "timeline.source_identity_admitted"},
		},
		InvariantIDs: []string{
