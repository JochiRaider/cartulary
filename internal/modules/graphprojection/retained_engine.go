...
func ProjectAdmittedRetainedProjection(run ProjectionRun, generatedAt time.Time, previousProjectionRunID *string) ProjectionRun {
	return projectAdmittedRun(run, projectOptions{GeneratedAt: generatedAt, PreviousProjectionRunID: previousProjectionRunID})
}
