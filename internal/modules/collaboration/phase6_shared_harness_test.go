...
func TestSupportPhase6SharedHarness_SocketLifecycleEvidenceIndex(t *testing.T) {
	evidence := map[string][]string{
		"canonical_handshake": {
			"internal/modules/collaboration/phase6_socket_test.go::TestPhase6_IncidentSocketHandshakeResume_U_6_07/first_application_message_must_be_hello_or_resume",
