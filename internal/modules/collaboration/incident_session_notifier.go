...
func NewIncidentSessionNotifier(db postgres.DB, hub *platformws.Hub) *IncidentSessionNotifier {
...
func (n *IncidentSessionNotifier) NotifyIncidentClosed(ctx context.Context, incidentID uuid.UUID) {
	...
	n.hub.TerminateIncident(incidentID, platformws.IncidentTerminalClosed)
}
