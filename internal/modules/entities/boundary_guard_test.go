...
var entitiesExportDispositions = map[string]map[string]entitiesExportDisposition{
	...
	"hostidentity": entitiesExportInventory(`
		...
		ReusableIdentifier RowVersionConflictError RowVersionConflictError.Error Store Store.ApplyClipboardPastePlan Store.ApplyClipboardPasteRequest Store.CreateHostRow
