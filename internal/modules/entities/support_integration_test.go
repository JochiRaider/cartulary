...
func (s *SupportScenario) seedWorkbookRouteFamilyData(t *testing.T, route workbookscenariotest.RouteInventoryEntry) {
	t.Helper()
...
func (s *SupportScenario) requireRouteSuccess(t *testing.T, route workbookscenariotest.RouteInventoryEntry, clientTxnID string, body any) map[string]any {
	t.Helper()
...
func (s *SupportScenario) requireRouteSuccessStatus(t *testing.T, route workbookscenariotest.RouteInventoryEntry, resp *http.Response, wantStatus int) map[string]any {
	t.Helper()
...
func (s *SupportScenario) doRoute(
	t *testing.T,
...
func (s *SupportScenario) applyAuthorizationChange(t *testing.T, route workbookscenariotest.RouteInventoryEntry) {
	t.Helper()
...
func (s *SupportScenario) queryAffectedRow(t *testing.T, route workbookscenariotest.RouteInventoryEntry, recordID string) (map[string]any, map[string]any) {
	t.Helper()
...
func assertRouteSuccessShape(t testing.TB, route workbookscenariotest.RouteInventoryEntry, scenario *SupportScenario, data map[string]any) {
	t.Helper()
...
func requireAffectedRecordID(t testing.TB, route workbookscenariotest.RouteInventoryEntry, scenario *SupportScenario, data map[string]any) string {
	t.Helper()
