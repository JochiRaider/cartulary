...
var Phase6HarnessIDs = []SharedHarnessID{
...
func Phase6WorkbookRouteInventory() []HarnessInventoryEntry {
...
func Phase6SocketEventInventory() []HarnessInventoryEntry {
	return []HarnessInventoryEntry{
		{
...
func RequireSharedHarnessInventory(t testing.TB, inventory []HarnessInventoryEntry) {
	...
	for _, entry := range inventory {
		...
		for _, harness := range Phase6HarnessIDs {
...
func requiredHarnesses(required ...SharedHarnessID) map[SharedHarnessID]HarnessRequirement {
	requirements := make(map[SharedHarnessID]HarnessRequirement, len(Phase6HarnessIDs))
	for _, harness := range Phase6HarnessIDs {
