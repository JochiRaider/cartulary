...
func TestCoordinationArtifactSurfacesUseContractFilters(t *testing.T) {
	tests := []struct {
		...
		{viewSchemaID: artifacts.CommLogViewSchemaID, artifactType: "comm_log"},
		{viewSchemaID: artifacts.HandoffViewSchemaID, artifactType: "handoff"},
		{viewSchemaID: artifacts.StatusReviewViewSchemaID, artifactType: "status_review"},
		{viewSchemaID: artifacts.LessonViewSchemaID, artifactType: "lesson"},
	}
