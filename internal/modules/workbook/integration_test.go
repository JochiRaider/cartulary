...
func CreateTimelineRow(t testing.TB, harness *workbookscenariotest.ServerHarness, login workbookscenariotest.LoginResult, incidentID uuid.UUID, clientTxnID string, summary string) map[string]any {
	t.Helper()
...
func CreateTimelineSameFieldConflict(t testing.TB, harness *workbookscenariotest.ServerHarness, firstLogin workbookscenariotest.LoginResult, secondLogin workbookscenariotest.LoginResult, recordID uuid.UUID, prefix string, savedValue string, localValue string) map[string]any {
	t.Helper()
...
func ResolveConflict(t testing.TB, harness *workbookscenariotest.ServerHarness, login workbookscenariotest.LoginResult, recordID uuid.UUID, conflictToken string, body map[string]any) map[string]any {
	t.Helper()
