...
func TestOwnerMutationAdmissionDistinguishesKnownNonWritableAndUnknownFields(t *testing.T) {
	tests := []struct {
		name            string
		fieldKey        string
	...
	}{
		{
			...
			fieldKey:        "note.created_at",
			wantDetailField: "note.created_at",
		},
		{
			name:            "unknown field retains owner key",
			fieldKey:        "note.not_a_field",
			wantDetailField: "note.not_a_field",
		},
	}
...
func TestOwnerMutationAdmissionAdmitsStructurallyValidOwnerSpecificCollectionOps(t *testing.T) {
...
func TestOwnerMutationAdmissionCollectionIDsAreExactLexicalTokens(t *testing.T) {
	stableID := "11111111-2222-3333-4444-555555555555"
	tests := []struct {
		name         string
		viewSchemaID string
...
func TestOwnerMutationAdmissionCollectionRemovalRequiresItemRef(t *testing.T) {
	stableID := "11111111-2222-3333-4444-555555555555"
	tests := []struct {
		name         string
		viewSchemaID string
