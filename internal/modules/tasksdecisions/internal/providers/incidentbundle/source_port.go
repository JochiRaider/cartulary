...
func tasksDecisionsSourceDescriptor() sourceport.Descriptor {
	return sourceport.Descriptor{
		...
		Paths: []sourceport.Path{
			{LogicalPath: "data/task_requests.ndjson", ContentRole: "source_rows", Versions: []int{4}, StableIdentity: []string{"record_id"}, StableIdentityInvariantID: "tasks_decisions.source_identity_admitted"},
			{LogicalPath: "data/decisions.ndjson", ContentRole: "source_rows", Versions: []int{4}, StableIdentity: []string{"record_id"}, StableIdentityInvariantID: "tasks_decisions.source_identity_admitted"},
		},
