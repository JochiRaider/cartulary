...
func NewContribution(
	...
	if len(sources) > 1 {
		return Contribution{}, fmt.Errorf("assessments projection contribution accepts at most one source")
	}
	contract, err := providercontract.NewContribution("assessments", descriptors, intents)
	if err != nil {
