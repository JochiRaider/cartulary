	...
	if got, want := catalog.PortabilityDescriptors(), []PortabilityDescriptor{
		{
			...
			SchemaID: "cartulary.incident_bundle.indicators.row.v1", Versions: []int{4},
		...
		},
		{
			...
			SchemaID: "cartulary.incident_bundle.indicator_observations.row.v1", Versions: []int{4},
		...
		},
		{
			...
			SchemaID: "cartulary.incident_bundle.indicator_state_intervals.row.v1", Versions: []int{4},
