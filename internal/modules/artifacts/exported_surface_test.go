...
// artifactRootExportClassifications is the reviewed Iteration 2 production
// boundary. S-11 replaces renamed entries atomically and removes owner-local
// entries; new root exports always require an explicit owner decision.
var artifactRootExportClassifications = map[string]exportDisposition{
	"CollectionAction":                    exportRetain,
	"CollectionActionPayload":             exportRetain,
	...
	"ContextualNoteCreateRequest":         exportRetain,
	"ContextualNoteCreateRequestHash":     exportRetain,
	...
	"IdempotencyRecord":                   exportRetain,
	...
	"MutationFacade.SourceIncident":       exportRetain,
	...
	"ParseRiskRefItemRef":                 exportRetain,
