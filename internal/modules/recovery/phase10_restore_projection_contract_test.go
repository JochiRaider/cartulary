...
func TestSupportPhase10_RestoreProjectionRebuildReceivesStructuredRequest(t *testing.T) {
...
func TestSupportPhase10_RestoreProjectionRebuildReadinessFailsClosed(t *testing.T) {
	ctx := context.Background()
