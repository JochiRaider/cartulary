...
func NewIncidentBundleSourcePort() sourceport.Port {
	descriptor := sourceport.Descriptor{
		...
		Paths: []sourceport.Path{
			{LogicalPath: "data/evidence_records.ndjson", ContentRole: "source_rows", Versions: []int{3, 4}, StableIdentity: []string{"record_id"}, StableIdentityInvariantID: "evidence.source_identity_admitted"},
			{LogicalPath: "data/evidence_custody_events.ndjson", ContentRole: "source_rows", Versions: []int{3, 4}, StableIdentity: []string{"custody_event_id"}, StableIdentityInvariantID: "evidence.source_identity_admitted"},
			{LogicalPath: "data/object_blobs.ndjson", ContentRole: "source_rows", Versions: []int{3, 4}, StableIdentity: []string{"object_blob_id"}, StableIdentityInvariantID: "evidence.source_identity_admitted"},
		},
		InvariantIDs: []string{
